...
module.exports = "\n<div class=\"center-align\">\n  <h1>\n    {{title}}\n  </h1>\n  <div>\n    <nav>\n    <div class=\"nav-wrapper red accent-4\">\n      <div class=\"col s12\">\n        <a href=\"#!\" (click)=\"goStep(0)\" class=\"breadcrumb form-link\" [ngClass]=\"{'active': step === 1}\">First</a>\n        <a href=\"#!\" (click)=\"form1.validStep1()\" class=\"breadcrumb form-link\" [ngClass]=\"{'active': step === 2}\">Second</a>\n        <a href=\"#!\" (click)=\"goStep(2)\" class=\"breadcrumb form-link\" [ngClass]=\"{'active': step === 3}\">Third</a>\n      </div>\n    </div>\n  </nav>\n  </div>\n  \n  <div>\n  <div class=\"form-steps\" style=\"width: 100%; overflow-x: hidden;\">\n  \n    <div style=\"\">\n      <app-form1 #form1 [formTitle]=\"formTitle\" [goStep2]=\"goStep2\" [currentStep]=\"step\" (stepValid)=\"handleStepValid($event, 0)\" [attr.data-hidden]=\"step != 1\" ></app-form1>\n      \n      <app-form2 #form2 [formTitle]=\"formTitle\" [goStep3]=\"goStep3\" [attr.data-hidden]=\"step != 2\" [currentStep]=\"step\" (stepValid)=\"handleStepValid($event, 1)\"></app-form2>\n      \n      <app-form3 [currentStep]=\"step\" [postData]=\"postData\" [attr.data-hidden]=\"step != 3\"></app-form3>\n    </div>\n\n  </div>\n  </div>\n\n</div>\n"
