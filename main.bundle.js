...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__useful_data_service__ = __webpack_require__(93);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__domhandler__ = __webpack_require__(168);
...
var Checkbox = (function () {
    function Checkbox(_translate) {
        ...
        this._translate.onLangChange.subscribe(function () {
            if (_this.label) {
                _this.updateTrad(_this.label);
            }
        });
    }
    Checkbox.prototype.ngOnChanges = function (changes) {
        if (changes['label'] && changes['label'].currentValue) {
            this.updateTrad(changes['label'].currentValue);
        }
    };
    Checkbox.prototype.updateTrad = function (key) {
        var _this = this;
        this._translate.get(key).subscribe(function (value) {
            _this.messageTrad = value;
        });
...
var Dropdown = (function () {
    function Dropdown(el, domHandler, renderer, differs, _translate) {
        ...
        this.mustExpandItems = [];
        this.mustExpand = false;
        this.deepSelectedOption = false;
        this.deepSelectedIndex = null;
    ...
    Dropdown.prototype.onExpandClick = function (event, option, index) {
        this.mustExpand = true;
        this.mustExpandItems[index] = !this.mustExpandItems[index];
    };
    ...
    Dropdown.prototype.onMouseclick = function (event, input) {
        ...
        if (!this.itemClick) {
            input.focus();
            if (this.panelVisible && !this.mustExpand)
                this.hide();
            else {
    ...
    Dropdown.prototype.findOptionIndex = function (val, opts) {
        ...
        if (opts) {
            for (var i = 0; i < opts.length; i++) {
                ...
                else if (opts[i].value == 'list') {
                    for (var g = 0; g < opts[i]['content'].length; g++) {
                        if ((val == null && opts[i]['content'][g]['value'] == null) || this.domHandler.equals(val, opts[i]['content'][g]['value'])) {
                            this.mustExpandItems[i] = true;
                            this.deepSelectedOption = true;
                            this.deepSelectedIndex = g;
                            index = i;
                            break;
                        }
                    }
    ...
    Dropdown.prototype.findOption = function (val, opts) {
        ...
        if (this.deepSelectedOption) {
            return (index != -1) ? opts[index]['content'][this.deepSelectedIndex] : null;
        }
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__common__ = __webpack_require__(240);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__angular_common__ = __webpack_require__(3);
...
var ContactDetailsComponent = (function () {
    ...
    ContactDetailsComponent.prototype.updateForm = function () {
        ...
        this.openingHsbcAccountReasons = this._usefuldataService.getOpeningHsbcAccountReason(this._translate.currentLang);
    ...
    ContactDetailsComponent.prototype.userHasPreviousAdress = function () {
        ...
        if (this._sharedModelService.model.informations.contactDetail.livesAtThisAddressSince) {
            if (this._sharedModelService.model.informations.person.birthDate) {
                var todayDate = new Date(), todayYear = todayDate.getFullYear(), todayMonth = todayDate.getMonth(), todayDay = todayDate.getDate(), livesAtThisAddressSinceDay = this._sharedModelService.model.informations.contactDetail.livesAtThisAddressSince.getDate(), livesAtThisAddressSinceMonth = this._sharedModelService.model.informations.contactDetail.livesAtThisAddressSince.getMonth(), livesAtThisAddressSinceYear = this._sharedModelService.model.informations.contactDetail.livesAtThisAddressSince.getFullYear();
                var timeDiff = Math.abs(todayDate.getTime() - this._sharedModelService.model.informations.contactDetail.livesAtThisAddressSince.getTime()), diffDays = Math.ceil(timeDiff / (1000 * 3600 * 24)), diff = (diffDays / 365);
                this._sharedModelService.model.informations.contactDetail.hasPreviousAddress = diff <= 3;
            }
        }
    ...
    ContactDetailsComponent.prototype.onTfChange = function (event) {
        try {
            if (this.liveAtAddressSinceMonth && this.liveAtAddressSinceMonth.trim().length == 2 &&
                ...
                var dateStr = this.liveAtAddressSinceMonth + '/30' + '/' + this.liveAtAddressSinceYear;
...
var CreditCardComponent = (function () {
    ...
    function CreditCardComponent(router, _location, _headerSteps, _sharedModelService, _fillDataStepService, _routerState, _scroll) {
        ...
        this.environment = __WEBPACK_IMPORTED_MODULE_9__environments_environment__["a" /* environment */];
        this.stepSubmitted = false;
        this.dirty = false;
        this.routerAnimation = this._routerState.lastAction;
        setTimeout(function () {
        ...
        this._sharedModelService.model.informations.account.creditCard.recommendedTypeCard = this._sharedModelService.model.informations.situation.getRecommendedTypeCard();
        this._sharedModelService.model.informations.account.creditCard.typeCard = this._sharedModelService.model.informations.situation.getRecommendedTypeCard();
        console.log('Recommended:', this._sharedModelService.model.informations.account.creditCard.recommendedTypeCard);
    }
    /**
     * Initialisations
     * @function ngOnInit
    ...
    CreditCardComponent.prototype.updateForm = function () {
    };
    /**
   * Move to the previous step
   * @function goBack
   */
    ...
    CreditCardComponent.prototype.next = function (type) {
        var _this = this;
        this.stepSubmitted = true;
        this._sharedModelService.model.informations.account.creditCard.typeCard = type;
        //this._sharedModelService.model.informations.account.creditCard.debitType = this.debitCreditCard;
        if (this._sharedModelService.model.informations.account.creditCard.validate()) {
            this._sharedModelService.mustSaveData.next(true);
            this.stepSubmitted = false;
            this.routerAnimation = 'prev';
            setTimeout(function () {
...
var FiscalInformationComponent = (function () {
     ...
     * @param {FillDataStepsChangerService} _fillDataStepService
     */
    function FiscalInformationComponent(_location, router, _translate, _headerSteps, _sharedModelService, _fillDataStepService, _countriesDataService, _routerState, _scroll) {
        var _this = this;
        this._location = _location;
        this.router = router;
        this._translate = _translate;
         ...
         */
        this.numbersInLetters = ["hsbc-main.second", "hsbc-main.third", "hsbc-main.fourth"];
        this.fiscalpaysAdd = [];
        this.fiscalPays = [];
        this.selectedPays = 'FR';
        this.stepSubmitted = false;
        this.msgWhereCountry = '';
        this.environment = __WEBPACK_IMPORTED_MODULE_12__environments_environment__["a" /* environment */];
        this.routerAnimation = "next";
        this.routerAnimation = this._routerState.lastAction;
        setTimeout(function () {
            _this.routerAnimation = 'next';
    ...
    FiscalInformationComponent.prototype.ngOnInit = function () {
        this._fillDataStepService.setCurrentStep({ step: __WEBPACK_IMPORTED_MODULE_4__services_fill_data_steps_changer_service__["b" /* FILL_DATA_STEPS */].SITUATION, subStep: 2 });
        this._headerSteps.setCurrentState(__WEBPACK_IMPORTED_MODULE_5__services_header_state_service__["b" /* HEADER_STATE */].FILL_DATA);
    };
    FiscalInformationComponent.prototype.updateForm = function () {
        var _this = this;
        this._countriesDataService.getCountries(this._translate.currentLang).then(function (data) {
    ...
    FiscalInformationComponent.prototype.openModalTaxWhere = function (taxWhereNum) {
        ...
        else if (taxWhereNum === 2) {
            this.msgWhereCountry = this._sharedModelService.model.informations.situation.taxInformation.countryOfTaxResidenceTwo;
        }
        else if (taxWhereNum === 3) {
            this.msgWhereCountry = this._sharedModelService.model.informations.situation.taxInformation.countryOfTaxResidenceThree;
        }
    ...
    FiscalInformationComponent.prototype.AddFiscalPays = function () {
        ...
        this._sharedModelService.model.informations.situation.taxInformation.numberOfSupFiscalCountries = this.fiscalpaysAdd.length;
    };
    /**
...
var MonthlyIncomeComponent = (function () {
     ...
     * @param {FillDataStepsChangerService} _fillDataStepService
     */
    function MonthlyIncomeComponent(translate, router, _location, _headerSteps, _fillDataStepService, _routerState, _scroll, _sharedModelService) {
        var _this = this;
        this.router = router;
        this._location = _location;
        this._headerSteps = _headerSteps;
    ...
    MonthlyIncomeComponent.prototype.onMonthlyNetSalaryChange = function (event) {
        if (event.value === undefined)
            ...
            this._sharedModelService.model.informations.situation.monthlyIncome.monthlyNetSalary = parseFloat(this.monthlyNetSalary);
            if (!parseFloat(this.monthlyNetSalary) && parseFloat(this.monthlyNetSalary) !== 0) {
                this._sharedModelService.model.informations.situation.monthlyIncome.monthlyNetSalaryError = "hsbc-main.error_field_only_numbers";
            }
            else {
                this._sharedModelService.model.informations.situation.validateMonthlyNetSalary(null, false);
            }
    ...
    MonthlyIncomeComponent.prototype.next = function () {
        var _this = this;
        this.stepSubmitted = true;
        if (this._sharedModelService.model.informations.situation.validate()) {
            this._sharedModelService.mustSaveData.next(true);
            this.stepSubmitted = false;
            this.routerAnimation = 'prev';
            setTimeout(function () {
    ...
    MonthlyIncomeComponent = __decorate([
        ...
        __metadata('design:paramtypes', [(typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_3_ng2_translate__["d" /* TranslateService */] !== 'undefined' && __WEBPACK_IMPORTED_MODULE_3_ng2_translate__["d" /* TranslateService */]) === 'function' && _a) || Object, (typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_1__angular_router__["a" /* Router */] !== 'undefined' && __WEBPACK_IMPORTED_MODULE_1__angular_router__["a" /* Router */]) === 'function' && _b) || Object, (typeof (_c = typeof __WEBPACK_IMPORTED_MODULE_2__angular_common__["b" /* Location */] !== 'undefined' && __WEBPACK_IMPORTED_MODULE_2__angular_common__["b" /* Location */]) === 'function' && _c) || Object, (typeof (_d = typeof __WEBPACK_IMPORTED_MODULE_5__services_header_state_service__["a" /* HeaderStateService */] !== 'undefined' && __WEBPACK_IMPORTED_MODULE_5__services_header_state_service__["a" /* HeaderStateService */]) === 'function' && _d) || Object, (typeof (_e = typeof __WEBPACK_IMPORTED_MODULE_4__services_fill_data_steps_changer_service__["a" /* FillDataStepsChangerService */] !== 'undefined' && __WEBPACK_IMPORTED_MODULE_4__services_fill_data_steps_changer_service__["a" /* FillDataStepsChangerService */]) === 'function' && _e) || Object, (typeof (_f = typeof __WEBPACK_IMPORTED_MODULE_8__services_router_state_service__["a" /* RouterStateService */] !== 'undefined' && __WEBPACK_IMPORTED_MODULE_8__services_router_state_service__["a" /* RouterStateService */]) === 'function' && _f) || Object, (typeof (_g = typeof __WEBPACK_IMPORTED_MODULE_6__services_scroll_service__["a" /* ScrollService */] !== 'undefined' && __WEBPACK_IMPORTED_MODULE_6__services_scroll_service__["a" /* ScrollService */]) === 'function' && _g) || Object, (typeof (_h = typeof __WEBPACK_IMPORTED_MODULE_7__services_shared_model_service__["a" /* SharedModelService */] !== 'undefined' && __WEBPACK_IMPORTED_MODULE_7__services_shared_model_service__["a" /* SharedModelService */]) === 'function' && _h) || Object])
...
var PatrimonyComponent = (function () {
     ...
     * @param {FillDataStepsChangerService} _fillDataStepService
     */
    function PatrimonyComponent(translate, router, _location, _headerSteps, _translate, _fillDataStepService, _routerState, _scroll, _countriesDataService, _sharedModelService, _usefulDataService) {
        var _this = this;
        this.router = router;
        this._location = _location;
        this._headerSteps = _headerSteps;
    ...
    PatrimonyComponent.prototype.next = function () {
        var _this = this;
        this.stepSubmitted = true;
        if (this._sharedModelService.model.informations.situation.patrimony.validate()) {
            this._sharedModelService.mustSaveData.next(true);
            this.stepSubmitted = false;
            this.routerAnimation = 'prev';
            setTimeout(function () {
    ...
    PatrimonyComponent.prototype.changeCheckedItem = function (checkedItem) {
        ...
        this._sharedModelService.model.informations.situation.patrimony.validatePatrimonyOrigin();
    };
    __decorate([
        __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["_2" /* HostBinding */])('@routerTransition'), 
        __metadata('design:type', Object)
    ...
    PatrimonyComponent = __decorate([
        ...
        __metadata('design:paramtypes', [(typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_3_ng2_translate__["d" /* TranslateService */] !== 'undefined' && __WEBPACK_IMPORTED_MODULE_3_ng2_translate__["d" /* TranslateService */]) === 'function' && _a) || Object, (typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_1__angular_router__["a" /* Router */] !== 'undefined' && __WEBPACK_IMPORTED_MODULE_1__angular_router__["a" /* Router */]) === 'function' && _b) || Object, (typeof (_c = typeof __WEBPACK_IMPORTED_MODULE_2__angular_common__["b" /* Location */] !== 'undefined' && __WEBPACK_IMPORTED_MODULE_2__angular_common__["b" /* Location */]) === 'function' && _c) || Object, (typeof (_d = typeof __WEBPACK_IMPORTED_MODULE_5__services_header_state_service__["a" /* HeaderStateService */] !== 'undefined' && __WEBPACK_IMPORTED_MODULE_5__services_header_state_service__["a" /* HeaderStateService */]) === 'function' && _d) || Object, (typeof (_e = typeof __WEBPACK_IMPORTED_MODULE_3_ng2_translate__["d" /* TranslateService */] !== 'undefined' && __WEBPACK_IMPORTED_MODULE_3_ng2_translate__["d" /* TranslateService */]) === 'function' && _e) || Object, (typeof (_f = typeof __WEBPACK_IMPORTED_MODULE_4__services_fill_data_steps_changer_service__["a" /* FillDataStepsChangerService */] !== 'undefined' && __WEBPACK_IMPORTED_MODULE_4__services_fill_data_steps_changer_service__["a" /* FillDataStepsChangerService */]) === 'function' && _f) || Object, (typeof (_g = typeof __WEBPACK_IMPORTED_MODULE_6__services_router_state_service__["a" /* RouterStateService */] !== 'undefined' && __WEBPACK_IMPORTED_MODULE_6__services_router_state_service__["a" /* RouterStateService */]) === 'function' && _g) || Object, (typeof (_h = typeof __WEBPACK_IMPORTED_MODULE_8__services_scroll_service__["a" /* ScrollService */] !== 'undefined' && __WEBPACK_IMPORTED_MODULE_8__services_scroll_service__["a" /* ScrollService */]) === 'function' && _h) || Object, (typeof (_j = typeof __WEBPACK_IMPORTED_MODULE_10__services_countries_data_service__["a" /* CountriesDataService */] !== 'undefined' && __WEBPACK_IMPORTED_MODULE_10__services_countries_data_service__["a" /* CountriesDataService */]) === 'function' && _j) || Object, (typeof (_k = typeof __WEBPACK_IMPORTED_MODULE_9__services_shared_model_service__["a" /* SharedModelService */] !== 'undefined' && __WEBPACK_IMPORTED_MODULE_9__services_shared_model_service__["a" /* SharedModelService */]) === 'function' && _k) || Object, (typeof (_l = typeof __WEBPACK_IMPORTED_MODULE_11__services_useful_data_service__["a" /* UsefulDataService */] !== 'undefined' && __WEBPACK_IMPORTED_MODULE_11__services_useful_data_service__["a" /* UsefulDataService */]) === 'function' && _l) || Object])
    ], PatrimonyComponent);
...
var ProfessionalSituationComponent = (function () {
   ...
   */
    ...
    ProfessionalSituationComponent.prototype.next = function () {
        var _this = this;
        this.stepSubmitted = true;
        if (this._sharedModelService.model.informations.situation.professionalSituation.validate()) {
            this._sharedModelService.mustSaveData.next(true);
            this.stepSubmitted = false;
            //this._sharedModelService.mustSaveData.next(true);
            this.routerAnimation = 'prev';
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_25__main_personal_information_second_page_personal_information_second_page_component__ = __webpack_require__(377);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_26__main_contact_details_contact_details_component__ = __webpack_require__(368);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_27__main_monthly_income_monthly_income_component__ = __webpack_require__(374);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_28__main_patrimony_patrimony_component__ = __webpack_require__(376);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_29__main_professional_situation_professional_situation_component__ = __webpack_require__(379);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_30__main_fiscal_information_fiscal_information_component__ = __webpack_require__(372);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_31__main_follow_account_pref_follow_account_pref_component__ = __webpack_require__(373);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_32__main_your_account_your_account_component__ = __webpack_require__(386);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_33__main_credit_card_credit_card_component__ = __webpack_require__(370);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_34__main_credit_card_second_page_credit_card_second_page_component__ = __webpack_require__(369);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_35__main_recap_validation_recap_validation_component__ = __webpack_require__(381);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_36__main_opening_account_information_opening_account_information_component__ = __webpack_require__(375);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_37__main_e_sign_e_sign_component__ = __webpack_require__(371);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_38__main_saved_e_sign_saved_e_sign_component__ = __webpack_require__(382);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_39__main_upload_proof_identity_upload_proof_identity_component__ = __webpack_require__(384);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_40__main_upload_proof_handwritten_signature_upload_proof_handwritten_signature_component__ = __webpack_require__(383);
...
console.log('Env:', __WEBPACK_IMPORTED_MODULE_50__environments_environment__["a" /* environment */].assetsPath);
// // Guards import
// import {PersonalInformationGuard} from './services/guards/personal-information-guard'
function createTranslateLoader(http) {
    return new __WEBPACK_IMPORTED_MODULE_16_ng2_translate__["a" /* TranslateStaticLoader */](http, __WEBPACK_IMPORTED_MODULE_50__environments_environment__["a" /* environment */].assetsPath + 'assets/i18n', '.json');
}
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__common_shared__ = __webpack_require__(241);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__directives_button_directive__ = __webpack_require__(365);
...
var PibTextArea = (function () {
    function PibTextArea(_translate) {
        var _this = this;
        this._translate = _translate;
        this.onModelChange = noop;
        this.onModelTouched = noop;
    ...
    PibTextArea.prototype.ngOnChanges = function (changes) {
        if (changes['message'] && changes['message'].currentValue) {
            this.updateTrad(changes['message'].currentValue);
        }
    };
    PibTextArea.prototype.updateTrad = function (key) {
        var _this = this;
        this._translate.get(key).subscribe(function (value) {
            _this.messageTrad = value;
        });
    ...
    __decorate([
        ...
        __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["_3" /* Output */])(), 
        __metadata('design:type', (typeof (_e = typeof __WEBPACK_IMPORTED_MODULE_0__angular_core__["i" /* EventEmitter */] !== 'undefined' && __WEBPACK_IMPORTED_MODULE_0__angular_core__["i" /* EventEmitter */]) === 'function' && _e) || Object)
    ], PibTextArea.prototype, "keyup", void 0);
    __decorate([
        //event fired when the input get hovered
        __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["e" /* Input */])(), 
        __metadata('design:type', String)
    ...
    __decorate([
        __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["e" /* Input */])(), 
        __metadata('design:type', Boolean)
    ], PibTextArea.prototype, "stepSubmitted", void 0);
    __decorate([
        __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["_4" /* ViewChild */])('inputText'), 
        __metadata('design:type', (typeof (_f = typeof __WEBPACK_IMPORTED_MODULE_0__angular_core__["d" /* ElementRef */] !== 'undefined' && __WEBPACK_IMPORTED_MODULE_0__angular_core__["d" /* ElementRef */]) === 'function' && _f) || Object)
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__services_header_state_service__ = __webpack_require__(14);
                ...
                _this.getTrackerValue(event.urlAfterRedirects, 'ti', function (value) {
                    ...
                    _this.getTrackerValue(event.urlAfterRedirects, 'dcsuri', function (value) {
                        ...
                        try {
                            ...
                            document.body.appendChild(trackerNode);
                        }
                        catch (e) {
...
var Model = (function () {
    function Model(prevData) {
        ...
        if (prevData) {
            ...
            this.informations.situation = new Situation();
            ...
            this.informations.situation.taxInformation = new TaxInformation();
            Object.assign(this.informations.situation.taxInformation, prevData.informations.situation.taxInformation);
...
var PersonalInformation = (function () {
    ...
    PersonalInformation.prototype.validateBirthCountry = function () {
        if (!this.birthCountry || this.birthCountry.trim().length == 0) {
            this.birthCountryError = REQUIRED;
            return false;
        }
        else {
            this.birthCountryError = null;
    ...
    PersonalInformation.prototype.validateNationality = function () {
    ...
    PersonalInformation.prototype.validateFamilySituation = function () {
        ...
        if (this.familySituation && this.familySituation == '2' && this.shouldValidateMartialStatus) {
            ...
            if ((!this.birthName || this.birthName.trim().length == 0) && this.civility === 'md') {
                this.birthNameError = REQUIRED;
                hasErrors = true;
            }
            else if (!this.validateOnlyLetters(this.birthName) && this.civility === 'md') {
...
var ContactDetails = (function () {
    function ContactDetails() {
        ...
        this.previousCountryError = null;
        this.postalCountry = null;
        this.postalCountryError = null;
    ...
    ContactDetails.prototype.validatePreviousCountry = function () {
        if ((!this.previousCountry || this.previousCountry.trim().length == 0) && this.hasPreviousAddress) {
            this.previousCountryError = REQUIRED;
            return false;
        }
        else {
            this.previousCountryError = null;
    ...
    ContactDetails.prototype.validatePostalCountry = function () {
        if ((!this.postalCountry || this.postalCountry.trim().length == 0) && this.isPostalAddressSameAsResidenceAddress == 'different') {
            this.postalCountryError = REQUIRED;
            return false;
        }
        else {
            this.postalCountryError = null;
    ...
    ContactDetails.prototype.validateCountry = function () {
    ...
    ContactDetails.prototype.validate = function () {
        ...
        if (!this.validatePreviousCountry()) {
            hasErrors = true;
        }
        if (!this.validatePostalCountry()) {
            hasErrors = true;
        }
...
var Situation = (function () {
    ...
    Situation.prototype.getRecommendedTypeCard = function () {
        var sumMonthlyIncome = Number(this.monthlyIncome.monthlyNetSalary) + Number(this.monthlyIncome.BICBNCMonthly) + Number(this.monthlyIncome.pensionsMonthlyRetirement) + Number(this.monthlyIncome.allowancesMonthly) + Number(this.monthlyIncome.otherMonthlyIncome);
        console.log(sumMonthlyIncome);
        // 'Visa Classic' 'Visa Premier' 'Gold Mastercard' 
        if (sumMonthlyIncome > 2500) {
            return 'Visa Premier';
        }
        else if (this.patrimony.accountsPatrimony === '50-100' || this.patrimony.accountsPatrimony === '100-200' || this.patrimony.accountsPatrimony === '200') {
            return 'Visa Premier';
        }
        else if (this.patrimony.financialTitles === '50-100' || this.patrimony.financialTitles === '100-200' || this.patrimony.financialTitles === '200') {
            return 'Visa Premier';
        }
        else if (this.patrimony.assurancePatrimony === '50-100' || this.patrimony.assurancePatrimony === '100-200' || this.patrimony.assurancePatrimony === '200') {
            return 'Visa Premier';
        }
        else if (this.patrimony.otherActivePatrimony === '50-100' || this.patrimony.otherActivePatrimony === '100-200' || this.patrimony.otherActivePatrimony === '200') {
            return 'Visa Premier';
        }
        else if (this.patrimony.accountsPatrimony === '10-50' && this.patrimony.financialTitles === '10-50' && this.patrimony.assurancePatrimony === '10-50' && this.patrimony.otherActivePatrimony === '10-50') {
            return 'Visa Premier';
        }
        else {
            return 'Visa Classic';
    ...
    Situation.prototype.validateOnlyNumberAndDecimals = function (numbers) {
        var re = /^[\d.]+$/;
        return re.test(numbers);
    };
    Situation.prototype.validateRequiredString = function (str) {
        if (str && str.trim().length > 0) {
            return true;
        }
        return false;
    };
    Situation.prototype.validateMonthlyNetSalary = function (e, submitStep) {
        if (this.professionalSituation.professionalStatus == 'salarie' || this.professionalSituation.professionalStatus == 'controleur_principal' || this.professionalSituation.professionalStatus == 'etudiant') {
            if ((!this.monthlyIncome.monthlyNetSalary && this.monthlyIncome.monthlyNetSalary != 0) || !this.validateRequiredString(this.monthlyIncome.monthlyNetSalary.toString())) {
                this.monthlyIncome.monthlyNetSalaryError = REQUIRED;
                return false;
            }
            else if (!this.validateOnlyNumberAndDecimals(this.monthlyIncome.monthlyNetSalary)) {
                this.monthlyIncome.monthlyNetSalaryError = INVALID_NUMBERS;
                return false;
            }
            else {
                this.monthlyIncome.monthlyNetSalaryError = null;
                return true;
            }
        }
        else {
            if (!this.monthlyIncome.monthlyNetSalary && submitStep) {
                this.monthlyIncome.monthlyNetSalary = 0;
                this.monthlyIncome.monthlyNetSalaryError = null;
                return true;
            }
            else if (!this.validateRequiredString(this.monthlyIncome.monthlyNetSalary.toString())) {
                return true;
            }
            else if (!this.validateOnlyNumberAndDecimals(this.monthlyIncome.monthlyNetSalary)) {
                this.monthlyIncome.monthlyNetSalaryError = INVALID_NUMBERS;
    ...
    Situation.prototype.validateBICBNCMonthly = function (e, submitStep) {
        if (this.professionalSituation.professionalStatus == 'chef_entreprise' || this.professionalSituation.professionalStatus == 'EI') {
            if ((!this.monthlyIncome.BICBNCMonthly && this.monthlyIncome.BICBNCMonthly != 0) || !this.validateRequiredString(this.monthlyIncome.BICBNCMonthly.toString())) {
                this.monthlyIncome.BICBNCMonthlyError = REQUIRED;
                return false;
            }
            else if (!this.validateOnlyNumberAndDecimals(this.monthlyIncome.BICBNCMonthly)) {
                this.monthlyIncome.BICBNCMonthlyError = INVALID_NUMBERS;
                return false;
            }
            else {
                this.monthlyIncome.BICBNCMonthlyError = null;
                return true;
            }
        }
        else {
            if (!this.monthlyIncome.BICBNCMonthly && submitStep) {
                this.monthlyIncome.BICBNCMonthly = 0;
                this.monthlyIncome.BICBNCMonthlyError = null;
                return true;
            }
            else if (!this.validateRequiredString(this.monthlyIncome.BICBNCMonthly.toString())) {
                return true;
            }
            else if (!this.validateOnlyNumberAndDecimals(this.monthlyIncome.BICBNCMonthly)) {
                this.monthlyIncome.BICBNCMonthlyError = INVALID_NUMBERS;
    ...
    Situation.prototype.validatePensionsMonthlyRetirement = function (e, submitStep) {
        if (this.professionalSituation.professionalStatus == 'retraite') {
            if ((!this.monthlyIncome.pensionsMonthlyRetirement && this.monthlyIncome.pensionsMonthlyRetirement != 0) || !this.validateRequiredString(this.monthlyIncome.pensionsMonthlyRetirement.toString())) {
                this.monthlyIncome.pensionsMonthlyRetirementError = REQUIRED;
                return false;
            }
            else if (!this.validateOnlyNumberAndDecimals(this.monthlyIncome.pensionsMonthlyRetirement)) {
                this.monthlyIncome.pensionsMonthlyRetirementError = INVALID_NUMBERS;
                return false;
            }
            else {
                this.monthlyIncome.pensionsMonthlyRetirementError = null;
                return true;
            }
        }
        else {
            if (!this.monthlyIncome.pensionsMonthlyRetirement && submitStep) {
                this.monthlyIncome.pensionsMonthlyRetirement = 0;
                this.monthlyIncome.pensionsMonthlyRetirementError = null;
                return true;
            }
            else if (!this.validateRequiredString(this.monthlyIncome.pensionsMonthlyRetirement.toString())) {
                return true;
            }
            else if (!this.validateOnlyNumberAndDecimals(this.monthlyIncome.pensionsMonthlyRetirement)) {
                this.monthlyIncome.pensionsMonthlyRetirementError = INVALID_NUMBERS;
    ...
    Situation.prototype.validateAllowancesMonthly = function (e, submitStep) {
        if (this.professionalSituation.professionalStatus == 'sans_profession') {
            if ((!this.monthlyIncome.allowancesMonthly && this.monthlyIncome.allowancesMonthly != 0) || !this.validateRequiredString(this.monthlyIncome.allowancesMonthly.toString())) {
                this.monthlyIncome.allowancesMonthlyError = REQUIRED;
                return false;
            }
            else if (!this.validateOnlyNumberAndDecimals(this.monthlyIncome.allowancesMonthly)) {
                this.monthlyIncome.allowancesMonthlyError = INVALID_NUMBERS;
                return false;
            }
            else {
                this.monthlyIncome.allowancesMonthlyError = null;
                return true;
            }
        }
        else {
            if (!this.monthlyIncome.allowancesMonthly && submitStep) {
                this.monthlyIncome.allowancesMonthly = 0;
                this.monthlyIncome.allowancesMonthlyError = null;
                return true;
            }
            else if (!this.validateRequiredString(this.monthlyIncome.allowancesMonthly.toString())) {
                return true;
            }
            else if (!this.validateOnlyNumberAndDecimals(this.monthlyIncome.allowancesMonthly)) {
                this.monthlyIncome.allowancesMonthlyError = INVALID_NUMBERS;
    ...
    Situation.prototype.validateOtherMonthlyIncome = function (e, submitStep) {
        if (!this.monthlyIncome.otherMonthlyIncome && submitStep) {
            this.monthlyIncome.otherMonthlyIncome = 0;
            this.monthlyIncome.otherMonthlyIncomeError = null;
            return true;
        }
        else if (!this.validateRequiredString(this.monthlyIncome.otherMonthlyIncome.toString())) {
            return true;
        }
        else if (!this.validateOnlyNumberAndDecimals(this.monthlyIncome.otherMonthlyIncome)) {
            this.monthlyIncome.otherMonthlyIncomeError = INVALID_NUMBERS;
            return false;
        }
        else {
            this.monthlyIncome.otherMonthlyIncomeError = null;
    ...
    Situation.prototype.validate = function () {
        var hasErrors = false;
        if (!this.validateBICBNCMonthly(null, true)) {
            hasErrors = true;
        }
        if (!this.validateAllowancesMonthly(null, true)) {
            hasErrors = true;
        }
        if (!this.validateMonthlyNetSalary(null, true)) {
            hasErrors = true;
        }
        if (!this.validatePensionsMonthlyRetirement(null, true)) {
            hasErrors = true;
        }
        if (!this.validateOtherMonthlyIncome(null, true)) {
            hasErrors = true;
        }
        return !hasErrors;
    };
...
var ProfessionalSituation = (function () {
    ...
    ProfessionalSituation.prototype.validateOnlyNumbers = function (numbers) {
        var re = /\d+/g;
        return re.test(numbers);
    };
    ...
    ProfessionalSituation.prototype.validateSIRET = function () {
        ...
        else if ((this.professionalStatus === 'EI' || this.professionalStatus === 'chef_entreprise') && !this.validateOnlyNumbers(this.SIRET)) {
            this.SIRETError = INVALID_NUMBERS;
            return false;
        }
        else {
...
var TaxInformation = (function () {
    function TaxInformation() {
        this.numberOfSupFiscalCountries = 0;
        this.countryOfTaxResidence = null;
        this.countryOfTaxResidenceTwo = null;
        this.countryOfTaxResidenceThree = null;
    }
    TaxInformation.prototype.validateOnlyNumberAndDecimals = function (numbers) {
        var re = /^[\d.]+$/;
        return re.test(numbers);
    };
    TaxInformation.prototype.validateRequiredString = function (str) {
        if (str && str.trim().length > 0) {
            return true;
        }
        return false;
    ...
    TaxInformation.prototype.validateNoTaxIdentificationNumberOption = function () {
        if (!this.noTaxIdentificationNumberOption || !this.validateRequiredString(this.noTaxIdentificationNumberOption.toString())) {
            this.noTaxIdentificationNumberOptionError = REQUIRED;
            return false;
        }
        else if (this.noTaxIdentificationNumberOption === 'Motif B' && (!this.reasonAbsenceNIF || !this.validateRequiredString(this.reasonAbsenceNIF))) {
            this.noTaxIdentificationNumberOptionError = null;
            this.reasonAbsenceNIFError = REQUIRED;
            return false;
        }
        this.noTaxIdentificationNumberOptionError = null;
        this.reasonAbsenceNIFError = null;
        return true;
    };
    TaxInformation.prototype.validateTaxIdentificationNumberTwo = function () {
        if ((!this.taxIdentificationNumberTwo || !this.validateRequiredString(this.taxIdentificationNumberTwo.toString())) && !this.hasNoTaxIdentificationNumberTwo) {
            this.taxIdentificationNumberTwoError = REQUIRED;
            return false;
        }
        else if (!this.validateOnlyNumberAndDecimals(this.taxIdentificationNumberTwo) && !this.hasNoTaxIdentificationNumberTwo) {
            this.taxIdentificationNumberTwoError = INVALID_NUMBERS;
            return false;
        }
        else if (this.hasNoTaxIdentificationNumberTwo) {
            this.taxIdentificationNumberTwoError = null;
            return false;
        }
        else {
            this.taxIdentificationNumberTwoError = null;
    ...
    TaxInformation.prototype.validateNoTaxIdentificationNumberOptionTwo = function () {
        ...
        else if (this.noTaxIdentificationNumberOptionTwo === 'Motif B' && (!this.reasonAbsenceNIFTwo || !this.validateRequiredString(this.reasonAbsenceNIFTwo))) {
            this.noTaxIdentificationNumberOptionTwoError = null;
            this.reasonAbsenceNIFTwoError = REQUIRED;
            return false;
        }
        this.noTaxIdentificationNumberOptionTwoError = null;
    ...
    TaxInformation.prototype.validateTaxIdentificationNumberThree = function () {
        if ((!this.taxIdentificationNumberThree || !this.validateRequiredString(this.taxIdentificationNumberThree.toString())) && !this.hasNoTaxIdentificationNumberThree) {
            this.taxIdentificationNumberThreeError = REQUIRED;
            return false;
        }
        else if (!this.validateOnlyNumberAndDecimals(this.taxIdentificationNumberThree) && !this.hasNoTaxIdentificationNumberThree) {
            this.taxIdentificationNumberThreeError = INVALID_NUMBERS;
            return false;
        }
        else if (this.hasNoTaxIdentificationNumberThree) {
            this.taxIdentificationNumberThreeError = null;
            return false;
        }
        else {
            this.taxIdentificationNumberThreeError = null;
    ...
    TaxInformation.prototype.validateNoTaxIdentificationNumberOptionThree = function () {
        if (!this.noTaxIdentificationNumberOptionThree || !this.validateRequiredString(this.noTaxIdentificationNumberOptionThree.toString())) {
            this.noTaxIdentificationNumberOptionThreeError = REQUIRED;
            return false;
        }
        else if (this.noTaxIdentificationNumberOptionThree === 'Motif B' && (!this.reasonAbsenceNIFThree || !this.validateRequiredString(this.reasonAbsenceNIFThree))) {
            this.noTaxIdentificationNumberOptionThreeError = null;
            this.reasonAbsenceNIFThreeError = REQUIRED;
            return false;
        }
        this.noTaxIdentificationNumberOptionThreeError = null;
        this.reasonAbsenceNIFThreeError = null;
        return true;
    };
...
var Patrimony = (function () {
    function Patrimony() {
        ...
        this.numberOfSupOriginCountryPatrimony = 0;
        this.mustValidateMainResidence = false;
    }
    Patrimony.prototype.validateRequiredString = function (str) {
        if (str && str.trim().length > 0) {
            return true;
        }
        return false;
    };
    Patrimony.prototype.validateOnlyNumberAndDecimals = function (numbers) {
        var re = /^[\d.]+$/;
        return re.test(numbers);
    };
    Patrimony.prototype.validatePatrimonyOrigin = function () {
        ...
        else if (!this.revenu && !this.heritage && !this.donation && !this.gain && this.nopatrimoine) {
            this.noOriginSelectedError = null;
            return true;
        }
        else if (this.revenu || this.heritage || this.donation || this.gain) {
            this.noOriginSelectedError = null;
            return true;
        }
    };
    Patrimony.prototype.validateOriginCountryPatrimonyOne = function () {
        if (!this.nopatrimoine && (!this.originCountryPatrimonyOne || !this.validateRequiredString(this.originCountryPatrimonyOne))) {
            this.originCountryPatrimonyOneError = REQUIRED;
            return false;
        }
        else {
            this.originCountryPatrimonyOneError = null;
            return true;
        }
    };
    Patrimony.prototype.validateOriginCountryPatrimonyTwo = function () {
        if (this.numberOfSupOriginCountryPatrimony < 1) {
            this.originCountryPatrimonyTwoError = null;
            return true;
        }
        if (!this.nopatrimoine && (!this.originCountryPatrimonyTwo || !this.validateRequiredString(this.originCountryPatrimonyTwo))) {
            this.originCountryPatrimonyTwoError = REQUIRED;
            return false;
        }
        else if (this.originCountryPatrimonyOne === this.originCountryPatrimonyTwo) {
            this.originCountryPatrimonyTwoError = INVALID_COUNTRY;
            return false;
        }
        else {
            this.originCountryPatrimonyTwoError = null;
    ...
    Patrimony.prototype.validateOriginCountryPatrimonyThree = function () {
        if (this.numberOfSupOriginCountryPatrimony < 2) {
            this.originCountryPatrimonyThreeError = null;
            return true;
        }
        if (!this.nopatrimoine && (!this.originCountryPatrimonyThree || !this.validateRequiredString(this.originCountryPatrimonyThree))) {
            this.originCountryPatrimonyThreeError = REQUIRED;
            return false;
        }
        else if (this.originCountryPatrimonyOne === this.originCountryPatrimonyThree || this.originCountryPatrimonyTwo === this.originCountryPatrimonyThree) {
            this.originCountryPatrimonyThreeError = INVALID_COUNTRY;
            return false;
        }
        else {
            this.originCountryPatrimonyThreeError = null;
    ...
    Patrimony.prototype.validateAccountsPatrimony = function () {
        if (!this.nopatrimoine) {
            if (!this.accountsPatrimony || !this.validateRequiredString(this.accountsPatrimony)) {
                this.accountsPatrimonyError = REQUIRED;
                return false;
            }
            else {
                this.accountsPatrimonyError = null;
                return true;
            }
        }
        else {
    ...
    Patrimony.prototype.validateFinancialTitles = function () {
        if (!this.nopatrimoine) {
            if (!this.financialTitles || !this.validateRequiredString(this.financialTitles)) {
                this.financialTitlesError = REQUIRED;
                return false;
            }
            else {
                this.financialTitlesError = null;
                return true;
            }
        }
        else {
    ...
    Patrimony.prototype.validateAssurancePatrimony = function () {
        if (!this.nopatrimoine) {
            if (!this.assurancePatrimony || !this.validateRequiredString(this.assurancePatrimony)) {
                this.assurancePatrimonyError = REQUIRED;
                return false;
            }
            else {
                this.assurancePatrimonyError = null;
                return true;
            }
        }
        else {
    ...
    Patrimony.prototype.validateOtherActivePatrimony = function () {
        if (!this.nopatrimoine) {
            if (!this.otherActivePatrimony || !this.validateRequiredString(this.otherActivePatrimony)) {
                this.otherActivePatrimonyError = REQUIRED;
                return false;
            }
            else {
                this.otherActivePatrimonyError = null;
                return true;
            }
        }
        else {
    ...
    Patrimony.prototype.validateMainResidencePatrimony = function () {
        if (!this.nopatrimoine) {
            if (!this.mainResidencePatrimony || !this.validateRequiredString(this.mainResidencePatrimony)) {
                this.mainResidencePatrimonyError = REQUIRED;
                return false;
            }
            else if (!this.validateOnlyNumberAndDecimals(this.mainResidencePatrimony)) {
                this.mainResidencePatrimonyError = INVALID_NUMBERS;
                return false;
            }
            else {
                this.mainResidencePatrimonyError = null;
                return true;
            }
        }
        else {
    ...
    Patrimony.prototype.hasNoPatrimony = function (event) {
        this.nopatrimoine = event;
        this.revenu = false;
        this.heritage = false;
        this.donation = false;
        this.gain = false;
    ...
    Patrimony.prototype.validate = function () {
        var hasErrors = false;
        if (!this.validatePatrimonyOrigin()) {
            hasErrors = true;
        }
        if (!this.validateOriginCountryPatrimonyOne()) {
            hasErrors = true;
        }
        if (!this.validateOriginCountryPatrimonyTwo()) {
            hasErrors = true;
        }
        if (!this.validateOriginCountryPatrimonyThree()) {
            hasErrors = true;
        }
        if (!this.validateAccountsPatrimony()) {
            hasErrors = true;
        }
        if (!this.validateFinancialTitles()) {
            hasErrors = true;
        }
        if (!this.validateAssurancePatrimony()) {
            hasErrors = true;
        }
        if (!this.validateOtherActivePatrimony()) {
            hasErrors = true;
        }
        if (!this.validateMainResidencePatrimony()) {
            hasErrors = true;
        }
        return !hasErrors;
    };
...
var CreditCard = (function () {
    function CreditCard() {
        this.noIntendCard = false;
    }
    CreditCard.prototype.validateRequiredString = function (str) {
        if (str && str.trim().length > 0) {
            return true;
        }
        return false;
    };
    CreditCard.prototype.validateTypeCard = function () {
        if (!this.typeCard || !this.validateRequiredString(this.typeCard)) {
            this.typeCardError = REQUIRED;
            return false;
        }
        else {
            this.typeCardError = null;
            return true;
        }
    };
    CreditCard.prototype.validateCardDebit = function () {
        switch (this.typeCard) {
            case 'Visa Classic':
                if (!this.vcDebitType) {
                    ...
                    this.debitType = this.vcDebitType;
                    this.vcDebitTypeError = null;
                    return true;
                }
            case 'Visa Premier':
                if (!this.vpDebitType) {
                    ...
                    this.debitType = this.vpDebitType;
                    this.vpDebitTypeError = null;
                    return true;
                }
            case 'Gold Mastercard':
                if (!this.gmDebitType) {
                    ...
                    this.debitType = this.gmDebitType;
                    this.gmDebitTypeError = null;
                    return true;
                }
            default:
                break;
    ...
    CreditCard.prototype.validate = function () {
        var hasErrors = false;
        if (!this.noIntendCard) {
            if (!this.validateTypeCard()) {
                hasErrors = true;
            }
            else if (!this.validateCardDebit()) {
                hasErrors = true;
            }
        }
        return !hasErrors;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__angular_router__ = __webpack_require__(7);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__main_account_type_account_type_component__ = __webpack_require__(367);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__main_personal_information_personal_informations_component__ = __webpack_require__(378);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__main_personal_information_second_page_personal_information_second_page_component__ = __webpack_require__(377);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__main_contact_details_contact_details_component__ = __webpack_require__(368);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__main_professional_situation_professional_situation_component__ = __webpack_require__(379);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__main_monthly_income_monthly_income_component__ = __webpack_require__(374);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__main_fiscal_information_fiscal_information_component__ = __webpack_require__(372);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__main_patrimony_patrimony_component__ = __webpack_require__(376);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__main_follow_account_pref_follow_account_pref_component__ = __webpack_require__(373);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__main_your_account_your_account_component__ = __webpack_require__(386);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__main_credit_card_credit_card_component__ = __webpack_require__(370);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__main_credit_card_second_page_credit_card_second_page_component__ = __webpack_require__(369);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__main_recap_validation_recap_validation_component__ = __webpack_require__(381);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15__main_opening_account_information_opening_account_information_component__ = __webpack_require__(375);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_16__main_e_sign_e_sign_component__ = __webpack_require__(371);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_17__main_saved_e_sign_saved_e_sign_component__ = __webpack_require__(382);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_18__main_upload_proof_identity_upload_proof_identity_component__ = __webpack_require__(384);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_19__main_upload_proof_handwritten_signature_upload_proof_handwritten_signature_component__ = __webpack_require__(383);
...
var routes = [
    ...
    },
    {
        ...
        canActivate: [__WEBPACK_IMPORTED_MODULE_25__services_guards_contact_details_guard__["a" /* ContactDetailsGuard */]]
    },
    {
        ...
        canActivate: [__WEBPACK_IMPORTED_MODULE_26__services_guards_professional_situation_guard__["a" /* ProfessionalSituationGuard */]]
    },
    {
        path: 'monthly-income',
...
var CreateAccountRoutingModule = (function () {
    ...
    CreateAccountRoutingModule = __decorate([
        __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["b" /* NgModule */])({
            ...
            providers: [__WEBPACK_IMPORTED_MODULE_23__services_guards_personal_information_guard__["a" /* PersonalInformationGuard */], __WEBPACK_IMPORTED_MODULE_24__services_guards_personal_information_second_page_guard__["a" /* PersonalInformationSecondPageGuard */], __WEBPACK_IMPORTED_MODULE_25__services_guards_contact_details_guard__["a" /* ContactDetailsGuard */], __WEBPACK_IMPORTED_MODULE_26__services_guards_professional_situation_guard__["a" /* ProfessionalSituationGuard */]]
        }), 
        __metadata('design:paramtypes', [])
...
var ContactDetailsGuard = (function () {
    function ContactDetailsGuard(_sharedModelService, router) {
        this._sharedModelService = _sharedModelService;
        this.router = router;
    }
    ContactDetailsGuard.prototype.canActivate = function (route, state) {
        try {
            if (this._sharedModelService.model.accountType === 'individualAccount' && this._sharedModelService.model.informations.person.isInformationsSecondPageValidate) {
                return true;
            }
            else if (this._sharedModelService.model.accountType === 'jointAccount' && this._sharedModelService.model.informations.person.isInformationsSecondPageValidate && this._sharedModelService.modelHolder.informations.person.isInformationsSecondPageValidate) {
                return true;
            }
            else {
    ...
    ContactDetailsGuard = __decorate([
        __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["f" /* Injectable */])(), 
    ...
    return ContactDetailsGuard;
    var _a, _b;
}());
//# sourceMappingURL=contact-details-guard.js.map
...
var ProfessionalSituationGuard = (function () {
    function ProfessionalSituationGuard(_sharedModelService, router) {
        this._sharedModelService = _sharedModelService;
        this.router = router;
    }
    ProfessionalSituationGuard.prototype.canActivate = function (route, state) {
        try {
            if (this._sharedModelService.model.accountType === 'individualAccount' && this._sharedModelService.model.informations.contactDetail.isContactDetailsValidate) {
                return true;
            }
            else if (this._sharedModelService.model.accountType === 'jointAccount' && this._sharedModelService.model.informations.contactDetail.isContactDetailsValidate && this._sharedModelService.modelHolder.informations.contactDetail.isContactDetailsValidate) {
                var step = parseInt(route.params['internalStep']);
                if (!step) {
                    this.router.navigate(['professional-situation/2']);
                }
                return false;
            }
            else if (this._sharedModelService.model.accountType === 'jointAccount' && this._sharedModelService.model.informations.contactDetail.isContactDetailsValidate && !this._sharedModelService.modelHolder.informations.contactDetail.isContactDetailsValidate) {
                this.router.navigate(['professional-situation/1']);
                return false;
            }
            else {
    ...
    ProfessionalSituationGuard = __decorate([
        __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["f" /* Injectable */])(), 
        __metadata('design:paramtypes', [(typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_2__shared_model_service__["a" /* SharedModelService */] !== 'undefined' && __WEBPACK_IMPORTED_MODULE_2__shared_model_service__["a" /* SharedModelService */]) === 'function' && _a) || Object, (typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_1__angular_router__["a" /* Router */] !== 'undefined' && __WEBPACK_IMPORTED_MODULE_1__angular_router__["a" /* Router */]) === 'function' && _b) || Object])
    ], ProfessionalSituationGuard);
    return ProfessionalSituationGuard;
    var _a, _b;
}());
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_rxjs_add_operator_map__ = __webpack_require__(542);
...
var CountriesDataService = (function () {
    ...
    CountriesDataService.prototype.getData = function (lang) {
        ...
        if (this.__data_loaded) {
            ...
            if (lang == 'fr') {
                return new Promise(function (resolve, reject) {
                    _this.http.get(__WEBPACK_IMPORTED_MODULE_4__environments_environment__["a" /* environment */].assetsPath + "assets/data/countries_fr.json")
                ...
                return new Promise(function (resolve, reject) {
                    _this.http.get(__WEBPACK_IMPORTED_MODULE_4__environments_environment__["a" /* environment */].assetsPath + "assets/data/countries.json")
                        .subscribe(function (data) {
                        _this.__data = data.json();
                        _this.__data_loaded = true;
                        _this.resolvePromise(resolve);
    ...
    CountriesDataService.prototype.getCountries = function (lang) {
        ...
        if (this.__data_loaded && lang == this.__data_lang) {
            return new Promise(function (resolve, reject) {
                _this.getCountriesData(resolve, lang);
            });
        }
        else {
            if (lang == 'fr') {
    ...
    CountriesDataService.prototype.getCountriesData = function (resolve, lang) {
        var data = [];
        var priv = ['FR', 'CH', 'DE', 'LU', 'US', 'IT', 'ES', 'UK'];
        var toSort = ['FR', 'AT', 'BE', 'CA', 'AE', 'US', 'HK', 'GB', 'SG', 'CH'];
        var customItems = [];
        for (var i = 0; i < this.__data.length; i++) {
            if (toSort.indexOf(this.__data[i].code) == -1) {
                data.push({
        ...
        for (var g = toSort.length - 1; g >= 0; g--) {
            ...
            var item = this.__data[itemIndex];
            g === 0 ? data.unshift({ label: '--------------', value: '' }) : null;
            data.unshift({
        ...
        if (lang == 'fr') {
            data.unshift({
                label: 'Veuillez sélectionner une valeur', value: ''
            });
        }
        else {
            data.unshift({
                label: 'Please choose a value', value: ''
            });
        }
        resolve(data);
    };
    CountriesDataService.prototype.resolvePromise = function (resolve) {
        ...
        data.sort(function (a, b) { return (a.label > b.label) ? 1 : ((b.label > a.label) ? -1 : 0); });
        resolve(data);
    };
    ...
    CountriesDataService.prototype.arrayObjectIndexOf = function (myArray, searchTerm, property) {
...
module.exports = "<div class=\"mt10 FEF__title sub\">\n    Votre carte\n    <div class=\"FEF__subtitle\">\n         Vous souhaitez souscrire à une carte bancaire internationale avec un maximum de garanties ?\n    </div>\n</div>\n<hr/>\n\n<div *ngIf=\"!_sharedModelService.model.informations.account.creditCard.noIntendCard\" class=\"pricing-table clearfix mt40\">\n\n    <div class=\"grid__col--4 pricing-table__item\" (click)=\"creditCardType('Visa Classic')\" [ngClass]=\"{'active':_sharedModelService.model.informations.account.creditCard.typeCard=='Visa Classic','expanded':showAdvantage == 'Visa Classic','no_border_bottom':showAdvantage}\">\n        <div \n        *ngIf=\"_sharedModelService.model.informations.account.creditCard.recommendedTypeCard === 'Visa Classic'\"\n        class=\"pricing-table__recommanded pricing-container\">Recommandé pour vous</div>\n\n        <div class=\"pricing-container--body\">\n            <img [src]=\"environment.assetsPath + 'assets/img/c1.png'\" alt=\"\">\n            <div class=\"pricing-table__title\">Carte Visa Classic <sup>(1)</sup></div>\n            <div class=\"pricing-table__description\">Tout simplement internationale</div>\n            <div *ngIf=\"_sharedModelService.model.informations.account.offer.hSBCHexagonConvention\" class=\"pricing-table__price\">8,10 <sup>€/an</sup></div>\n            <div *ngIf=\"!_sharedModelService.model.informations.account.offer.hSBCHexagonConvention\" class=\"pricing-table__price\">45 <sup>€/an</sup></div>\n\n            <div class=\"panel mt20\">\n                <div class=\"panel__title\">Type de débit <sup>(3)</sup></div>\n                <div class=\"panel__detail\">\n                    <div class=\"mb10\">\n                        <pib-radioButton \n                          name=\"rb_1\" \n                          label=\"Débit différé\" \n                          value=\"CBD\" \n                          [(ngModel)]=\"_sharedModelService.model.informations.account.creditCard.vcDebitType\"\n                          (onClick)=\"_sharedModelService.model.informations.account.creditCard.validateCardDebit()\"\n                        ></pib-radioButton>\n                    </div>\n                    <div class=\"mb10\">\n                        <pib-radioButton \n                          name=\"rb_1\" \n                          label=\"Débit différé\" \n                          value=\"CBD\" \n                          [(ngModel)]=\"_sharedModelService.model.informations.account.creditCard.vcDebitType\"\n                          (onClick)=\"_sharedModelService.model.informations.account.creditCard.validateCardDebit()\"\n                        ></pib-radioButton>\n                    </div>\n                    <div class=\"form__message form__message--error\" *ngIf=\"_sharedModelService.model.informations.account.creditCard.vcDebitTypeError && (stepSubmitted || dirty)\">\n                        <i class=\"icon icon-circle-delete\"></i> {{_sharedModelService.model.informations.account.creditCard.vcDebitTypeError | translate}}\n                    </div>\n                </div>\n            </div>\n        </div>\n        <div class=\"pricing-container\">\n\n\n            <a class=\"more\" (click)=\"showAdvantageOf($event,'Visa Classic')\">Découvrir les avantages</a>\n            <div *ngIf=\"showAdvantage == 'Visa Classic'\" class=\"is-displayed-mobile\">\n                <div>\n                    <b>Carte Visa Classic (1)</b>\n                </div>\n                <div>\n                    <b>Avantages</b>\n                </div>\n                <br><br>\n                <ul class=\"list-dots\">\n                    <li>Vos paiements en France et à l’étranger</li>\n                    <li>Vos retraits gratuits dans tous les distributeurs HSBC à travers le monde<sup>(3)</sup></li>\n                    <li>Des assurances et assistances incluses lors de vos déplacements, et ce dès la souscription</li>\n                </ul>\n                <br>\n                <a class=\"underlined\">Téléchargez notre brochure comparative des cartes</a>\n                <br><br>\n                <ul class=\"ordered-list\">\n                    <li>(1) Souscription sous réserve d'acceptation de la banque. Voir les conditions prévues au contrat disponibles sur www.hsbc.fr.</li>\n                    <li>(2) Tarif en vigueur au 01/07/2016.</li>\n                    <li>(3) Des commissions sont néanmoins susceptibles d’être perçues par la banque locale dans certains pays.</li>\n                </ul>\n            </div>\n            <a class=\"btn--tertiary full is-hidden-mobile\" (click)=\"next('Visa Classic')\" *ngIf=\"!showAdvantage\">Choisir</a>\n            <a class=\"btn--tertiary full is-displayed-mobile\" (click)=\"next('Visa Classic')\">Choisir</a>\n        </div>\n\n    </div>\n\n\n    <div class=\"grid__col--4 pricing-table__item\" (click)=\"creditCardType('Visa Premier')\" [ngClass]=\"{'active':_sharedModelService.model.informations.account.creditCard.typeCard=='Visa Premier','expanded':showAdvantage == 'Visa Premier','no_border_bottom':showAdvantage}\">\n        <div \n        *ngIf=\"_sharedModelService.model.informations.account.creditCard.recommendedTypeCard === 'Visa Premier'\"\n        class=\"pricing-table__recommanded pricing-container\">Recommandé pour vous</div>\n\n        <div class=\"pricing-container--body\">\n            <img [src]=\"environment.assetsPath + 'assets/img/c2.png'\" alt=\"\">\n            <div class=\"pricing-table__title\">Carte Visa Premier <sup>(1)</sup></div>\n            <div class=\"pricing-table__description\">Tout simplement internationale</div>\n\n\n            <div *ngIf=\"_sharedModelService.model.informations.account.offer.hSBCHexagonConvention\" class=\"pricing-table__price\">14,45 <sup>€/an</sup></div>\n            <div *ngIf=\"!_sharedModelService.model.informations.account.offer.hSBCHexagonConvention\" class=\"pricing-table__price\">134 <sup>€/an</sup></div>\n\n            <div class=\"panel mt20\">\n                <div class=\"panel__title\">Type de débit <sup>(3)</sup></div>\n                <div class=\"panel__detail\">\n                    <div class=\"mb10\">\n                        <pib-radioButton \n                          name=\"rb_2\" \n                          label=\"Débit différé\" \n                          value=\"CBD\" \n                          [(ngModel)]=\"_sharedModelService.model.informations.account.creditCard.vpDebitType\"\n                          (onClick)=\"_sharedModelService.model.informations.account.creditCard.validateCardDebit()\"\n                        ></pib-radioButton>\n                    </div>\n                    \n\n                    <div class=\"mb10\">\n                        <pib-radioButton \n                          name=\"rb_2\" \n                          value=\"CBI\" \n                          label=\"Débit immédiat\" \n                          [(ngModel)]=\"_sharedModelService.model.informations.account.creditCard.vpDebitType\"\n                          (onClick)=\"_sharedModelService.model.informations.account.creditCard.validateCardDebit()\"\n                        ></pib-radioButton>\n                    </div>\n                    <div class=\"form__message form__message--error\" *ngIf=\"_sharedModelService.model.informations.account.creditCard.vpDebitTypeError && (stepSubmitted || dirty)\">\n                        <i class=\"icon icon-circle-delete\"></i> {{_sharedModelService.model.informations.account.creditCard.vpDebitTypeError | translate}}\n                    </div>\n                </div>\n            </div>\n\n        </div>\n        <div class=\"pricing-container\">\n\n\n            <a class=\"more\" (click)=\"showAdvantageOf($event,'Visa Premier')\">Découvrir les avantages</a>\n            <div *ngIf=\"showAdvantage == 'Visa Premier'\" class=\"is-displayed-mobile\">\n                <div>\n                    <b>Carte Visa Premier <sup>(1)</sup></b>\n                </div>\n                <div>\n                    <b>Avantages</b>\n                </div>\n                <br><br>\n                <ul class=\"list-dots\">\n                    <li>Des plafonds élevés pour vos retraits et paiements</li>\n                    <li>Vos retraits gratuits à l’étranger dans tous les distributeurs HSBC à travers le monde<sup>(3)</sup></li>\n                    <li>Des assurances et assistances élargies pour voyager en toute sérénité</li>\n                    <li>Une garantie qui assure vos achats pendant 30 jours en cas de dommage accidentel</li>\n                    <li>Des réductions et avantages spécifiques auprès des partenaires Visa Premier</li>\n                </ul>\n                <br>\n                <a class=\"underlined\">Téléchargez notre brochure comparative des cartes</a>\n                <br><br>\n                <ul class=\"ordered-list\">\n                    <li>(1) Souscription sous réserve d’acceptation de la banque. Voir les conditions prévues au contrat disponibles sur www.hsbc.fr.</li>\n                    <li>(2) Tarif en vigueur au 01/07/2016.</li>\n                    <li>(3) Des commissions sont néanmoins susceptibles d’être perçues par la banque locale dans certains pays.</li>\n                </ul>\n\n\n            </div>\n            <a class=\"btn--tertiary full is-hidden-mobile\" (click)=\"next('Visa Premier')\" *ngIf=\"!showAdvantage\">Choisir</a>\n            <a class=\"btn--tertiary full is-displayed-mobile\" (click)=\"next('Visa Premier')\">Choisir</a>\n        </div>\n\n    </div>\n\n\n    <div class=\"grid__col--4 pricing-table__item\" (click)=\"creditCardType('Gold Mastercard')\" [ngClass]=\"{'active':_sharedModelService.model.informations.account.creditCard.typeCard=='Gold Mastercard','expanded':showAdvantage == 'Gold Mastercard','no_border_bottom':showAdvantage}\">\n        <div class=\"pricing-table__recommanded pricing-container\">&nbsp;</div>\n\n        <div class=\"pricing-container--body\">\n            <img [src]=\"environment.assetsPath + 'assets/img/c3.png'\" alt=\"\">\n            <div class=\"pricing-table__title\">Carte Gold Mastercard <sup>(1)</sup></div>\n            <div class=\"pricing-table__description\">Tout simplement internationale</div>\n\n\n            <div *ngIf=\"_sharedModelService.model.informations.account.offer.hSBCHexagonConvention\" class=\"pricing-table__price\">14,45 <sup>€/an</sup></div>\n            <div *ngIf=\"!_sharedModelService.model.informations.account.offer.hSBCHexagonConvention\" class=\"pricing-table__price\">134 <sup>€/an</sup></div>\n\n            <div class=\"panel mt20\">\n                <div class=\"panel__title\">Type de débit <sup>(3)</sup></div>\n                <div class=\"panel__detail\">\n                    <div class=\"mb10\">\n                        <pib-radioButton \n                          name=\"rb_3\" \n                          label=\"Débit différé\" \n                          value=\"CBD\" \n                          [(ngModel)]=\"_sharedModelService.model.informations.account.creditCard.gmDebitType\"\n                          (onClick)=\"_sharedModelService.model.informations.account.creditCard.validateCardDebit()\"\n                        ></pib-radioButton>\n                    </div>\n                    <div class=\"mb10\">\n                        <pib-radioButton \n                          name=\"rb_3\" \n                          value=\"CBI\" \n                          label=\"Débit immédiat\" \n                          [(ngModel)]=\"_sharedModelService.model.informations.account.creditCard.gmDebitType\"\n                          (onClick)=\"_sharedModelService.model.informations.account.creditCard.validateCardDebit()\"\n                        ></pib-radioButton>\n                    </div>\n                    <div class=\"form__message form__message--error\" *ngIf=\"_sharedModelService.model.informations.account.creditCard.gmDebitTypeError && (stepSubmitted || dirty)\">\n                        <i class=\"icon icon-circle-delete\"></i> {{_sharedModelService.model.informations.account.creditCard.gmDebitTypeError | translate}}\n                    </div>\n                </div>\n            </div>\n        </div>\n        <div class=\"pricing-container\">\n\n\n            <a class=\"more\" (click)=\"showAdvantageOf($event,'Gold Mastercard')\">Découvrir les avantages</a>\n            <div *ngIf=\"showAdvantage == 'Gold Mastercard'\" class=\"is-displayed-mobile\">\n                <div>\n                    <b>Carte Gold Mastercard <sup>(1)</sup></b>\n                </div>\n                <div>\n                    <b>Avantages</b>\n                </div>\n                <br><br>\n                <ul class=\"list-dots\">\n                    <li>Des plafonds importants pour vos retraits et paiements</li>\n                    <li>Vos retraits gratuits à l’étranger dans tous les distributeurs HSBC à travers le monde<sup>(3)</sup></li>\n                    <li>Des assurances et assistances élargies pour voyager en toute sérénité</li>\n                    <li>Une garantie qui assure vos achats pendant 30 jours en cas de dommage accidentel</li>\n                </ul>\n                <br>\n                <a class=\"underlined\">Téléchargez notre brochure comparative des cartes</a>\n                <br><br>\n                <ul class=\"ordered-list\">\n                    <li>(1) Souscription sous réserve d’acceptation de la banque. Voir les conditions prévues au contrat disponibles sur www.hsbc.fr.</li>\n                    <li>(2) Tarif en vigueur au 01/07/2016.</li>\n                    <li>(3) Des commissions sont néanmoins susceptibles d’être perçues par la banque locale dans certains pays.</li>\n                </ul>\n            </div>\n\n            <a class=\"btn--tertiary full is-hidden-mobile\" (click)=\"next('Gold Mastercard')\" *ngIf=\"!showAdvantage\">Choisir</a>\n            <a class=\"btn--tertiary full is-displayed-mobile\" (click)=\"next('Gold Mastercard')\">Choisir</a>\n        </div>\n\n    </div>\n</div>\n<div class=\"card__detail\" *ngIf=\"showAdvantage\">\n    <div *ngIf=\"showAdvantage == 'Visa Classic'\" class=\"is-hidden-mobile\" style=\"position:relative;\">\n        <div>\n            <b>Carte Visa Classic (1)</b>\n        </div>\n        <div>\n            <b>Avantages</b>\n        </div>\n        <br><br>\n        <ul class=\"list-dots\">\n\n            <li>Vos paiements en France et à l’étranger</li>\n            <li>Vos retraits gratuits dans tous les distributeurs HSBC à travers le monde(3)</li>\n            <li>Des assurances et assistances incluses lors de vos déplacements, et ce dès la souscription</li>\n        </ul>\n        <br>\n        <a class=\"underlined\">Téléchargez notre brochure comparative des cartes</a>\n        <br><br>\n        <ul class=\"ordered-list\">\n            <li>(1) Souscription sous réserve d’acceptation de la banque. Voir les conditions prévues au contrat disponibles sur www.hsbc.fr.</li>\n            <li>(2) Tarif en vigueur au 01/07/2016.</li>\n            <li>(3) Des commissions sont néanmoins susceptibles d’être perçues par la banque locale dans certains pays.</li>\n        </ul>\n\n        <a class=\"cancel-link\" (click)=\"closeAdvantages()\" style=\"right: 25px;text-align: right;bottom: 27px;top: initial;left:initial;\"><i class=\"icon icon-delete\"></i> Fermer</a>\n    </div>\n    <div *ngIf=\"showAdvantage == 'Visa Premier'\" class=\"is-hidden-mobile\" style=\"position:relative;\">\n        <div>\n            <b>Carte Visa Premier <sup>(1)</sup></b>\n        </div>\n        <div>\n            <b>Avantages</b>\n        </div>\n        <br><br>\n        <ul class=\"list-dots\">\n            <li>Des plafonds élevés pour vos retraits et paiements</li>\n            <li>Vos retraits gratuits à l’étranger dans tous les distributeurs HSBC à travers le monde<sup>(3)</sup></li>\n            <li>Des assurances et assistances élargies pour voyager en toute sérénité</li>\n            <li>Une garantie qui assure vos achats pendant 30 jours en cas de dommage accidentel</li>\n            <li>Des réductions et avantages spécifiques auprès des partenaires Visa Premier</li>\n        </ul>\n        <br>\n        <a class=\"underlined\">Téléchargez notre brochure comparative des cartes</a>\n        <br><br>\n        <ul class=\"ordered-list\">\n            <li>(1) Souscription sous réserve d’acceptation de la banque. Voir les conditions prévues au contrat disponibles sur www.hsbc.fr.</li>\n            <li>(2) Tarif en vigueur au 01/07/2016.</li>\n            <li>(3) Des commissions sont néanmoins susceptibles d’être perçues par la banque locale dans certains pays.</li>\n        </ul>\n\n        <a class=\"cancel-link\" (click)=\"closeAdvantages()\" style=\"right: 25px;text-align: right;bottom: 27px;top: initial;left:initial;\"><i class=\"icon icon-delete\"></i> Fermer</a>\n    </div>\n    <div *ngIf=\"showAdvantage == 'Gold Mastercard'\" class=\"is-hidden-mobile\" style=\"position:relative;\">\n        <div>\n            <b>Carte Gold Mastercard <sup>(1)</sup></b>\n        </div>\n        <div>\n            <b>Avantages</b>\n        </div>\n        <br><br>\n        <ul class=\"list-dots\">\n            <li>Des plafonds importants pour vos retraits et paiements</li>\n            <li>Vos retraits gratuits à l’étranger dans tous les distributeurs HSBC à travers le monde<sup>(3)</sup></li>\n            <li>Des assurances et assistances élargies pour voyager en toute sérénité</li>\n            <li>Une garantie qui assure vos achats pendant 30 jours en cas de dommage accidentel</li>\n        </ul>\n        <br>\n        <a class=\"underlined\">Téléchargez notre brochure comparative des cartes</a>\n        <br><br>\n        <ul class=\"ordered-list\">\n            <li>(1) Souscription sous réserve d’acceptation de la banque. Voir les conditions prévues au contrat disponibles sur www.hsbc.fr.</li>\n            <li>(2) Tarif en vigueur au 01/07/2016.</li>\n            <li>(3) Des commissions sont néanmoins susceptibles d’être perçues par la banque locale dans certains pays.</li>\n        </ul>\n\n        <a class=\"cancel-link\" (click)=\"closeAdvantages()\" style=\"right: 25px;text-align: right;bottom: 27px;top: initial;left:initial;\"><i class=\"icon icon-delete\"></i> Fermer</a>\n    </div>\n    <div class=\"clearfix\">\n        <div *ngIf=\"showAdvantage\" class=\"grid__col--4 is-hidden-mobile\" style=\"padding-left: 23px;padding-right: 23px;width: calc(100%/3);\">\n            <a class=\"btn--tertiary is-hidden-mobile full\" *ngIf=\"showAdvantage\" (click)=\"next('Visa Classic')\" [attr.disabled]=\"showAdvantage == 'Visa Classic'?null:true\">Choisir</a>\n        </div>\n        <div *ngIf=\"showAdvantage\" class=\"grid__col--4 is-hidden-mobile\" style=\"padding-left: 23px;padding-right: 23px;width: calc(100%/3);\">\n            <a class=\"btn--tertiary is-hidden-mobile full\" *ngIf=\"showAdvantage\" (click)=\"next('Visa Premier')\" [attr.disabled]=\"showAdvantage == 'Visa Premier'?null:true\">Choisir</a>\n        </div>\n        <div *ngIf=\"showAdvantage\" class=\"grid__col--4 is-hidden-mobile\" style=\"padding-left: 23px;padding-right: 23px;width: calc(100%/3);\">\n            <a class=\"btn--tertiary is-hidden-mobile full\" *ngIf=\"showAdvantage\" (click)=\"next('Gold Mastercard')\" [attr.disabled]=\"showAdvantage == 'Gold Mastercard'?null:true\">Choisir</a>\n        </div>\n    </div>\n</div>\n\n<div class=\"mt35\">\n    <pib-checkbox name=\"cb_3\" \n      [(ngModel)]=\"_sharedModelService.model.informations.account.creditCard.noIntendCard\" \n      binary=\"true\" \n      [label]=\"'Je ne souhaite pas souscrire à une carte bancaire.'\"\n      (onChange)=\"_sharedModelService.model.informations.account.creditCard.noIntendCard ? _sharedModelService.model.informations.account.creditCard.typeCard = null : null\"\n      ></pib-checkbox>\n\n      <button pibButton type=\"button\" *ngIf=\"_sharedModelService.model.informations.account.creditCard.noIntendCard\" (click)=\"next()\" label=\"{{'hsbc-main.suivant' | translate}}\" class=\"btn--primary f-right\">\n      </button>\n</div>\n\n\n<div class=\"mt10\">\n    <a (click)=\"goBack()\" class=\"btn--back\">{{'hsbc-main.retour'|translate}}</a>\n</div>"
...
module.exports = "<div class=\"mt10 FEF__title sub\">\n    {{'hsbc-main.monthly_income' | translate}}\n    <div class=\"FEF__subtitle\">\n        {{'hsbc-main.tout_champs_obligatoires' | translate}}\n    </div>\n</div>\n<hr/>\n\n<div class=\"clearfix\">\n    <div class=\"grid__col--8 no-padding\">\n         <div class=\"panel--alert\">\n            <div class=\"panel__title\">\n                <i class=\"icon icon-circle-info\"></i>\n                Pourquoi demandons-nous ces informations ?\n            </div>\n            <p>\n                Pour toute ouverture de compte, la réglementation demande aux établissements bancaires de justifier une parfaite connaissance client et des opérations qu’ils\n                effectuent. Ces informations seront exclusivement utilisées dans le cadre de notre relation bancaire et nous permettront de vous offrir la meilleure qualité de service.\n            </p>\n        </div>\n        \n        <div [ngSwitch]=\"_sharedModelService.model.informations.situation.professionalSituation.professionalStatus\">\n          \n          <div *ngSwitchCase=\"_sharedModelService.model.informations.situation.professionalSituation.professionalStatus == 'salarie' || _sharedModelService.model.informations.situation.professionalSituation.professionalStatus == 'controleur_principal' || _sharedModelService.model.informations.situation.professionalSituation.professionalStatus == 'etudiant' ? _sharedModelService.model.informations.situation.professionalSituation.professionalStatus : '' \" class=\"form__group\">\n              <div class=\"form__label\">Salaire(s) net(s) mensuel(s)</div>\n              <div>\n                  <pib-text-field \n                    (keyup)=\"_sharedModelService.model.informations.situation.validateMonthlyNetSalary($event, false)\"\n                    placeholder=\"€\" \n                    inputClass=\"euro-unit\" \n                    [(ngModel)]=\"_sharedModelService.model.informations.situation.monthlyIncome.monthlyNetSalary\"\n                    [stepSubmitted]=\"stepSubmitted\"\n                    [message]= \"_sharedModelService.model.informations.situation.monthlyIncome.monthlyNetSalaryError\"\n                  ></pib-text-field>\n              </div>\n          </div>\n\n          <div *ngSwitchCase=\"_sharedModelService.model.informations.situation.professionalSituation.professionalStatus == 'EI' || _sharedModelService.model.informations.situation.professionalSituation.professionalStatus == 'chef_entreprise' ? _sharedModelService.model.informations.situation.professionalSituation.professionalStatus : ''\" class=\"form__group\">\n              <div class=\"form__label\">BIC / BNC mensuel(s)</div>\n              <div>\n                  <pib-text-field \n                    placeholder=\"€\" \n                    inputClass=\"euro-unit\" \n                    [(ngModel)]=\"_sharedModelService.model.informations.situation.monthlyIncome.BICBNCMonthly\"\n                    (keyup)=\"_sharedModelService.model.informations.situation.validateBICBNCMonthly($event, false)\"\n                    [stepSubmitted]=\"stepSubmitted\"\n                    [message]= \"_sharedModelService.model.informations.situation.monthlyIncome.BICBNCMonthlyError\"\n                  ></pib-text-field>\n              </div>\n          </div>\n\n          <div *ngSwitchCase=\"'retraite'\" class=\"form__group\">\n              <div class=\"form__label\">Pensions / Retraite mensuelle(s)</div>\n              <div>\n                  <pib-text-field \n                    placeholder=\"€\" \n                    inputClass=\"euro-unit\" \n                    [(ngModel)]=\"_sharedModelService.model.informations.situation.monthlyIncome.pensionsMonthlyRetirement\"\n                    (keyup)=\"_sharedModelService.model.informations.situation.validatePensionsMonthlyRetirement($event, false)\"\n                    [stepSubmitted]=\"stepSubmitted\"\n                    [message]= \"_sharedModelService.model.informations.situation.monthlyIncome.pensionsMonthlyRetirementError\"\n                  ></pib-text-field>\n              </div>\n          </div>\n          \n          <div *ngSwitchCase=\"'sans_profession'\" class=\"form__group\">\n              <div class=\"form__label\">Allocations (Chômage…) mensuelle(s)</div>\n              <div>\n                  <pib-text-field \n                    placeholder=\"€\" \n                    inputClass=\"euro-unit\" \n                    [(ngModel)]=\"_sharedModelService.model.informations.situation.monthlyIncome.allowancesMonthly\"\n                    (keyup)=\"_sharedModelService.model.informations.situation.validateAllowancesMonthly($event, false)\"\n                    [stepSubmitted]=\"stepSubmitted\"\n                    [message]= \"_sharedModelService.model.informations.situation.monthlyIncome.allowancesMonthlyError\"\n                  ></pib-text-field>\n              </div>\n          </div>\n\n        </div>\n          \n        <div *ngIf=\"!anotherSourceOfIncomeAdded || _sharedModelService.model.informations.situation.anotherSourceOfIncomeAdded\" class=\"mb35\"><a class=\"add-link\" (click)=\"addAnotherSourceOfIncome()\">+ Ajouter une autre source de revenu</a> </div>\n        <div class=\"panel panel--form\"  *ngIf=\"anotherSourceOfIncomeAdded || _sharedModelService.model.informations.situation.anotherSourceOfIncomeAdded\">\n            <div *ngIf=\"_sharedModelService.model.informations.situation.professionalSituation.professionalStatus != 'salarie' && _sharedModelService.model.informations.situation.professionalSituation.professionalStatus != 'controleur_principal' && _sharedModelService.model.informations.situation.professionalSituation.professionalStatus != 'etudiant'\" class=\"form__group\">\n              <div class=\"form__label\">Salaire(s) net(s) mensuel(s)</div>\n              <div>\n                  <pib-text-field \n                    (change)=\"onMonthlyNetSalaryChange($event, false)\" \n                    placeholder=\"€\" \n                    inputClass=\"euro-unit\" \n                    [ngModel]=\"monthlyNetSalary\"\n                    [stepSubmitted]=\"stepSubmitted\"\n                    [message]= \"_sharedModelService.model.informations.situation.monthlyIncome.monthlyNetSalaryError\"\n                  ></pib-text-field>\n              </div>\n          </div>\n\n            <div *ngIf=\"_sharedModelService.model.informations.situation.professionalSituation.professionalStatus != 'EI' && _sharedModelService.model.informations.situation.professionalSituation.professionalStatus != 'chef_entreprise'\" class=\"form__group\">\n                <div class=\"form__label\">BIC / BNC mensuel(s)</div>\n                <div>\n                    <pib-text-field \n                      placeholder=\"€\" \n                      inputClass=\"euro-unit\" \n                      [(ngModel)]=\"_sharedModelService.model.informations.situation.monthlyIncome.BICBNCMonthly\"\n                    (keyup)=\"_sharedModelService.model.informations.situation.validateBICBNCMonthly($event, false)\"\n                    [stepSubmitted]=\"stepSubmitted\"\n                    [message]= \"_sharedModelService.model.informations.situation.monthlyIncome.BICBNCMonthlyError\"\n                    ></pib-text-field>\n                </div>\n            </div>\n            <div *ngIf=\"_sharedModelService.model.informations.situation.professionalSituation.professionalStatus != 'retraite'\" class=\"form__group\">\n                <div class=\"form__label\">Pensions / Retraite mensuelle(s)</div>\n                <div>\n                    <pib-text-field \n                    placeholder=\"€\" \n                    inputClass=\"euro-unit\" \n                    [(ngModel)]=\"_sharedModelService.model.informations.situation.monthlyIncome.pensionsMonthlyRetirement\"\n                    (keyup)=\"_sharedModelService.model.informations.situation.validatePensionsMonthlyRetirement($event, false)\"\n                    [stepSubmitted]=\"stepSubmitted\"\n                    [message]= \"_sharedModelService.model.informations.situation.monthlyIncome.pensionsMonthlyRetirementError\"\n                  ></pib-text-field>\n                </div>\n            </div>\n            <div *ngIf=\"_sharedModelService.model.informations.situation.professionalSituation.professionalStatus != 'sans_profession'\" class=\"form__group\">\n                <div class=\"form__label\">Allocations (Chômage…) mensuelle(s)</div>\n                <div>\n                    <pib-text-field \n                    placeholder=\"€\" \n                    inputClass=\"euro-unit\" \n                    [(ngModel)]=\"_sharedModelService.model.informations.situation.monthlyIncome.allowancesMonthly\"\n                    (keyup)=\"_sharedModelService.model.informations.situation.validateAllowancesMonthly($event, false)\"\n                    [stepSubmitted]=\"stepSubmitted\"\n                    [message]= \"_sharedModelService.model.informations.situation.monthlyIncome.allowancesMonthlyError\"\n                  ></pib-text-field>\n                </div>\n            </div>\n            <div class=\"form__group\">\n                <div class=\"form__label\">Autre revenus mensuel(s)</div>\n                <div>\n                    <pib-text-field \n                      placeholder=\"€\" \n                      inputClass=\"euro-unit\" \n                      (keyup)=\"_sharedModelService.model.informations.situation.validateOtherMonthlyIncome($event, false)\"\n                      [stepSubmitted]=\"stepSubmitted\"\n                      [message]= \"_sharedModelService.model.informations.situation.monthlyIncome.otherMonthlyIncomeError\"\n                      [(ngModel)]=\"_sharedModelService.model.informations.situation.monthlyIncome.otherMonthlyIncome\"\n                      ></pib-text-field>\n                </div>\n                <a class=\"cancel-link\" (click)=\"Cancel()\"><i class=\"icon icon-delete\"></i> Annuler</a>\n            </div>\n\n        </div>\n        <button pibButton type=\"button\" (click)=\"next()\" label=\"{{'hsbc-main.suivant' | translate}}\" class=\"btn--primary f-right\">\n                    </button>\n\n        <a (click)=\"goBack()\" class=\"btn--back\">{{'hsbc-main.retour'|translate}}</a>\n\n        <hr class=\"bottom-hr\"/>\n\n        <div class=\"f-right bottom-help\">\n            <i class=\"icon icon-circle-help\"></i> {{'hsbc-main.help' | translate}}\n        </div>\n    </div>\n</div>"
...
module.exports = "<div class=\"mt10 FEF__title sub\">\n    {{'hsbc-main.patrimony' | translate}}\n    <div class=\"FEF__subtitle\">\n        {{'hsbc-main.tout_champs_obligatoires' | translate}}\n    </div>\n</div>\n<hr/>\n<div class=\"clearfix \">\n    <div class=\"grid__col--8 no-padding\">\n        <div class=\"panel--alert\">\n            <div class=\"panel__title\">\n                <i class=\"icon icon-circle-info\"></i>\n                {{'hsbc-main.patrimony_question' | translate}}\n            </div>\n            <p>\n                {{'hsbc-main.patrimony_desc' | translate}}\n            </p>\n        </div>\n\n        <div>\n            <div class=\"mb10\" style=\"font-size: 16px;\">{{'hsbc-main.patrimony_origin' | translate}}</div>\n            <div>\n                    <div class=\"mb10\">\n                        <pib-checkbox name=\"cb_1\"  \n                          [(ngModel)]=\"_sharedModelService.model.informations.situation.patrimony.revenu\" \n                          binary=\"true\" \n                          label=\"{{'hsbc-main.patrimony_pro_revenus' | translate}}\" \n                          (onChange)=\"changeCheckedItem(1)\"\n                        ></pib-checkbox>\n                    </div>\n                    <div class=\"mb10\">\n                      <pib-checkbox \n                        name=\"cb_2\"  \n                        [(ngModel)]=\"_sharedModelService.model.informations.situation.patrimony.heritage\" \n                        binary=\"true\" \n                        label=\"{{'hsbc-main.patrimony_heritage' | translate}}\" \n                        (onChange)=\"changeCheckedItem(2)\"\n                      ></pib-checkbox>\n                    </div>\n                    <div class=\"mb10\">\n                      <pib-checkbox \n                        name=\"cb_3\"  \n                        [(ngModel)]=\"_sharedModelService.model.informations.situation.patrimony.donation\" \n                        binary=\"true\" \n                        label=\"{{'hsbc-main.patrimony_donation' | translate}}\" \n                        [label]=\"'Donation'\" \n                        (onChange)=\"changeCheckedItem(3)\"\n                      ></pib-checkbox>\n                    </div>\n                    <div class=\"mb10\">\n                      <pib-checkbox name=\"cb_4\"  \n                        [(ngModel)]=\"_sharedModelService.model.informations.situation.patrimony.gain\" \n                        binary=\"true\" \n                        label=\"{{'hsbc-main.patrimony_gains' | translate}}\" \n                        (onChange)=\"changeCheckedItem(4)\"\n                      ></pib-checkbox>\n                    </div>\n                  <div class=\"mb10\">\n                    <pib-checkbox name=\"cb_4\"  \n                        binary=\"true\" \n                        (onChange)=\"_sharedModelService.model.informations.situation.patrimony.hasNoPatrimony($event);this._sharedModelService.model.informations.situation.patrimony.validatePatrimonyOrigin();dirty=true;\"\n                        [(ngModel)]=\"_sharedModelService.model.informations.situation.patrimony.nopatrimoine\"\n                        label=\"{{'hsbc-main.patrimony_no_have' | translate}}\"\n                      ></pib-checkbox>\n                    <!-- <pib-radioButton \n                      (onClick)=\"_sharedModelService.model.informations.situation.patrimony.hasNoPatrimony()\"\n                      [(ngModel)]=\"_sharedModelService.model.informations.situation.patrimony.nopatrimoine\"\n                      [label]=\"'Je ne dispose pas de patrimoine'\"noOriginSelectedError\n                    ></pib-radioButton> -->\n                  </div>\n                  <div class=\"form__message form__message--error\" *ngIf=\"_sharedModelService.model.informations.situation.patrimony.noOriginSelectedError && (dirty || stepSubmitted)\">\n                      <i class=\"icon icon-circle-delete\"></i> {{_sharedModelService.model.informations.situation.patrimony.noOriginSelectedError | translate}}\n                  </div>\n            </div>\n    </div>\n\n\n        <div  class=\"panel panel__form mt20\" *ngIf=\"_sharedModelService.model.informations.situation.patrimony.revenu || _sharedModelService.model.informations.situation.patrimony.heritage || _sharedModelService.model.informations.situation.patrimony.donation || _sharedModelService.model.informations.situation.patrimony.gain\">\n            <div class=\"form__group\">\n               <div class=\"form__label\">{{'hsbc-main.patrimony_country_question' | translate}}</div>\n                <div>\n                    <pib-dropdown \n                      [options]=\"countries\" \n                      [message]=\"_sharedModelService.model.informations.situation.patrimony.originCountryPatrimonyOneError\" \n                      messageType=\"ERROR\" \n                      [stepSubmitted]=\"stepSubmitted\"\n                      [(ngModel)]=\"_sharedModelService.model.informations.situation.patrimony.originCountryPatrimonyOne\"\n                      (onChange)=\"_sharedModelService.model.informations.situation.patrimony.validateOriginCountryPatrimonyOne()\"\n                    ></pib-dropdown>\n                </div> \n            </div>\n\n            <div *ngIf=\"_sharedModelService.model.informations.situation.patrimony.numberOfSupOriginCountryPatrimony >= 1\" class=\"form__group\">\n               <div class=\"form__label\">{{'hsbc-main.patrimony_country_question' | translate}}</div>\n                <div>\n                    <pib-dropdown \n                      [options]=\"countries\" \n                      [message]=\"_sharedModelService.model.informations.situation.patrimony.originCountryPatrimonyTwoError\" \n                      messageType=\"ERROR\" \n                      [stepSubmitted]=\"stepSubmitted\"\n                      [(ngModel)]=\"_sharedModelService.model.informations.situation.patrimony.originCountryPatrimonyTwo\"\n                      (onChange)=\"_sharedModelService.model.informations.situation.patrimony.validateOriginCountryPatrimonyTwo()\"\n                    ></pib-dropdown>\n                </div> \n            </div>\n\n            <div *ngIf=\"_sharedModelService.model.informations.situation.patrimony.numberOfSupOriginCountryPatrimony >= 2\" class=\"form__group\">\n               <div class=\"form__label\">{{'hsbc-main.patrimony_country_question' | translate}}</div>\n                <div>\n                    <pib-dropdown \n                      [options]=\"countries\" \n                      [(ngModel)]=\"_sharedModelService.model.informations.situation.patrimony.originCountryPatrimonyThree\"\n                      [message]=\"_sharedModelService.model.informations.situation.patrimony.originCountryPatrimonyThreeError\" \n                      messageType=\"ERROR\" \n                      [stepSubmitted]=\"stepSubmitted\"\n                      (onChange)=\"_sharedModelService.model.informations.situation.patrimony.validateOriginCountryPatrimonyThree()\"\n                    ></pib-dropdown>\n                </div> \n            </div>\n\n            \n            <div>\n              <a \n              *ngIf=\"_sharedModelService.model.informations.situation.patrimony.numberOfSupOriginCountryPatrimony < 2\"\n              (click)=\"_sharedModelService.model.informations.situation.patrimony.numberOfSupOriginCountryPatrimony = _sharedModelService.model.informations.situation.patrimony.numberOfSupOriginCountryPatrimony + 1\"><b>{{'hsbc-main.patrimony_country_add' | translate}}</b></a>\n              <br><br>\n              <a \n              style=\"right: 25px;text-align: right;bottom: 27px;top: initial;left:initial;\"\n              *ngIf=\"_sharedModelService.model.informations.situation.patrimony.numberOfSupOriginCountryPatrimony >= 1\"\n              (click)=\"_sharedModelService.model.informations.situation.patrimony.numberOfSupOriginCountryPatrimony = _sharedModelService.model.informations.situation.patrimony.numberOfSupOriginCountryPatrimony - 1\"><b><i class=\"icon icon-delete\"></i> {{'hsbc-main.annuler'|translate}}</b></a>\n            </div>\n        </div>\n    </div>\n</div>\n\n\n<div *ngIf=\"_sharedModelService.model.informations.situation.patrimony.revenu || _sharedModelService.model.informations.situation.patrimony.heritage || _sharedModelService.model.informations.situation.patrimony.donation || _sharedModelService.model.informations.situation.patrimony.gain\">\n\n  <h2 class=\"form__title\">{{'hsbc-main.patrimony_actifs' | translate}}</h2>\n\n\n  <div class=\"clearfix\">\n      <div class=\"grid__col--8\">\n          <div class=\"form__group\">\n              <div class=\"form__label\">{{'hsbc-main.patrimony_actifs_accounts' | translate}}</div>\n              <div>\n                  <pib-dropdown \n                    [options]=\"amounts\" \n                    [(ngModel)]=\"_sharedModelService.model.informations.situation.patrimony.accountsPatrimony\"\n                    [message]=\"_sharedModelService.model.informations.situation.patrimony.accountsPatrimonyError\" \n                    messageType=\"ERROR\" \n                    [stepSubmitted]=\"stepSubmitted\"\n                    (onChange)=\"_sharedModelService.model.informations.situation.patrimony.validateAccountsPatrimony()\"\n                  ></pib-dropdown>\n              </div>\n          </div>\n          <div class=\"form__group\">\n              <div class=\"form__label\">{{'hsbc-main.patrimony_actifs_titles' | translate}}</div>\n              <div>\n                  <pib-dropdown \n                    [options]=\"amounts\" \n                    [(ngModel)]=\"_sharedModelService.model.informations.situation.patrimony.financialTitles\"\n                    [message]=\"_sharedModelService.model.informations.situation.patrimony.financialTitlesError\" \n                    messageType=\"ERROR\" \n                    [stepSubmitted]=\"stepSubmitted\"\n                    (onChange)=\"_sharedModelService.model.informations.situation.patrimony.validateFinancialTitles()\"\n                  ></pib-dropdown>\n              </div>\n          </div>\n          <div class=\"form__group\">\n              <div class=\"form__label\">{{'hsbc-main.patrimony_actifs_assurance' | translate}}</div>\n              <div>\n                  <pib-dropdown \n                    [options]=\"amounts\" \n                    [(ngModel)]=\"_sharedModelService.model.informations.situation.patrimony.assurancePatrimony\"\n                    [message]=\"_sharedModelService.model.informations.situation.patrimony.assurancePatrimonyError\" \n                    messageType=\"ERROR\" \n                    [stepSubmitted]=\"stepSubmitted\"\n                    (onChange)=\"_sharedModelService.model.informations.situation.patrimony.validateAssurancePatrimony()\"\n                  ></pib-dropdown>\n              </div>\n          </div>\n          <div class=\"form__group\">\n              <div class=\"form__label\">{{'hsbc-main.patrimony_actifs_others' | translate}}</div>\n              <div>\n                  <pib-dropdown \n                    [options]=\"amounts\" \n                    [(ngModel)]=\"_sharedModelService.model.informations.situation.patrimony.otherActivePatrimony\"\n                    [message]=\"_sharedModelService.model.informations.situation.patrimony.otherActivePatrimonyError\" \n                    messageType=\"ERROR\" \n                    [stepSubmitted]=\"stepSubmitted\"\n                    (onChange)=\"_sharedModelService.model.informations.situation.patrimony.validateOtherActivePatrimony()\"\n                  ></pib-dropdown>\n              </div>\n          </div>\n          \n\n\n      </div>\n  </div>\n\n\n  <h2 class=\"form__title\">{{'hsbc-main.patrimony_immo' | translate}}</h2>\n\n  <div class=\"clearfix\">\n      <div class=\"grid__col--8\">\n          <div class=\"form__group\">\n              <div class=\"form__label\">{{'hsbc-main.patrimony_immo_residence' | translate}}</div>\n              <div>\n                  <pib-text-field \n                    placeholder=\"€\"  \n                    inputClass=\"euro-unit\" \n                    [(ngModel)]=\"_sharedModelService.model.informations.situation.patrimony.mainResidencePatrimony\"\n                    [message]=\"_sharedModelService.model.informations.situation.patrimony.mainResidencePatrimonyError\" \n                    messageType=\"ERROR\" \n                    [stepSubmitted]=\"stepSubmitted\"\n                    (keyup)=\"_sharedModelService.model.informations.situation.patrimony.validateMainResidencePatrimony()\"\n                  ></pib-text-field>\n              </div>\n          </div>\n          \n          <div class=\"form__group\">\n              <div class=\"form__label\">{{'hsbc-main.patrimony_immo_others' | translate}}</div>\n              <div>\n                  <pib-text-field \n                    placeholder=\"€\"  \n                    inputClass=\"euro-unit\" \n                    [(ngModel)]=\"_sharedModelService.model.informations.situation.patrimony.otherImmoPatrimony\"\n                  ></pib-text-field>\n              </div>\n          </div>\n\n      </div>\n  </div>\n</div>\n<button pibButton type=\"button\" (click)=\"next()\" label=\"{{'hsbc-main.suivant' | translate}}\" class=\"btn--primary f-right\">\n                      </button>\n\n<a (click)=\"goBack()\" class=\"btn--back\">{{'hsbc-main.retour'|translate}}</a>\n\n<hr class=\"bottom-hr\"/>\n\n<div class=\"f-right bottom-help\">\n    <i class=\"icon icon-circle-help\"></i> {{'hsbc-main.help' | translate}}\n</div>"
...
module.exports = "\n<div class=\"mt10 FEF__title sub\">\n    {{'hsbc-main.votre_situation_prof' | translate}}\n    <div class=\"FEF__subtitle\">\n        {{'hsbc-main.tout_champs_obligatoires' | translate}}\n    </div>\n</div>\n<hr/>\n\n\n<div class=\"clearfix\">\n    <div class=\"grid__col--8 no-padding\">\n        <div>\n            <div class=\"panel--alert\">\n                <div class=\"panel__title\">\n                <i class=\"icon icon-circle-info\"></i>\n\n                    {{'hsbc-main.pourquoi_demandons_ces_informations' | translate}}\n                </div>\n                <p>\n                    {{'hsbc-main.notice_ouverture_compte' | translate}}\n                </p>\n            </div>\n        </div>\n\n        <div class=\"form__group\">\n            <div class=\"form__label\">{{'hsbc-main.situation_prof'|translate}}</div>\n            <div>\n                <pib-dropdown \n                  [options]=\"profissionalSituations\" \n                  [message]=\"_sharedModelService.model.informations.situation.professionalSituation.professionalStatusError\" messageType=\"ERROR\"\n                  [stepSubmitted]=\"stepSubmitted\"\n                  (onChange)=\"_sharedModelService.model.informations.situation.professionalSituation.validateProfessionalStatus();_sharedModelService.model.informations.situation.professionalSituation.professionalCategory = '' \"\n                  [(ngModel)]=\"_sharedModelService.model.informations.situation.professionalSituation.professionalStatus\"\n                  ></pib-dropdown>\n            </div>\n        </div>\n        <div class=\"panel panel--form\" *ngIf=\"_sharedModelService.model.informations.situation.professionalSituation.professionalStatus && _sharedModelService.model.informations.situation.professionalSituation.professionalStatus != 'sans_profession'\">\n            <div *ngIf=\"_sharedModelService.model.informations.situation.professionalSituation.professionalStatus === 'EI' || _sharedModelService.model.informations.situation.professionalSituation.professionalStatus === 'chef_entreprise'\" class=\"form__group\">\n                <div class=\"form__label\">SIRET</div>\n                <div>\n                    <pib-text-field \n                      placeholder=\"SIRET\" \n                      messageType= \"ERROR\"\n                      (keyup)=\"_sharedModelService.model.informations.situation.professionalSituation.validateSIRET($event)\"\n                      [stepSubmitted]=\"stepSubmitted\"\n                      [message]= \"_sharedModelService.model.informations.situation.professionalSituation.SIRETError\"\n                      [(ngModel)]=\"_sharedModelService.model.informations.situation.professionalSituation.SIRET\"\n                      ></pib-text-field>\n                </div>\n            </div>\n            <div *ngIf=\"_sharedModelService.model.informations.situation.professionalSituation.professionalStatus === 'EI' || _sharedModelService.model.informations.situation.professionalSituation.professionalStatus === 'chef_entreprise'\" class=\"form__group\">\n                <div class=\"form__label\">NACE</div>\n                <div>\n                    <pib-text-field \n                      placeholder=\"NACE\" \n                      (keyup)=\"_sharedModelService.model.informations.situation.professionalSituation.validateNACE($event)\"\n                      [stepSubmitted]=\"stepSubmitted\"\n                      [message]= \"_sharedModelService.model.informations.situation.professionalSituation.NACEError\"\n                      [(ngModel)]=\"_sharedModelService.model.informations.situation.professionalSituation.NACE\"\n                      ></pib-text-field>\n                </div>\n            </div>\n            <div *ngIf=\"_sharedModelService.model.informations.situation.professionalSituation.professionalStatus === 'salarie'\" class=\"form__group\">\n                <div class=\"form__label\">{{'hsbc-main.type_contrat'|translate}}</div>\n                <div>\n                    <pib-dropdown \n                      [options]=\"contractTypes\" \n                      [message]=\"_sharedModelService.model.informations.situation.professionalSituation.contractTypeError\" messageType=\"ERROR\"\n                      [stepSubmitted]=\"stepSubmitted\"\n                      (onChange)=\"_sharedModelService.model.informations.situation.professionalSituation.validateContractType()\"\n                      [(ngModel)]=\"_sharedModelService.model.informations.situation.professionalSituation.contractType\"\n                    ></pib-dropdown>\n                </div>\n            </div>\n            <div *ngIf=\"_sharedModelService.model.informations.situation.professionalSituation.professionalStatus === 'salarie' || _sharedModelService.model.informations.situation.professionalSituation.professionalStatus === 'controleur_principal'\" class=\"form__group\">\n                <div class=\"form__label\">{{'hsbc-main.categorie_prof'|translate}}</div>\n                <div>\n                    <pib-dropdown \n                      [options]=\"employeeProfessionalCategories\" \n                      [message]=\"_sharedModelService.model.informations.situation.professionalSituation.professionalCategoryError\" \n                      filteredList=\"true\"\n                      messageType=\"ERROR\"\n                      [stepSubmitted]=\"stepSubmitted\"\n                      (onChange)=\"_sharedModelService.model.informations.situation.professionalSituation.validateProfessionalCategory()\"\n                      [(ngModel)]=\"_sharedModelService.model.informations.situation.professionalSituation.professionalCategory\"\n                    ></pib-dropdown>\n                </div>\n            </div>\n            <div *ngIf=\"_sharedModelService.model.informations.situation.professionalSituation.professionalStatus === 'EI'\" class=\"form__group\">\n                <div class=\"form__label\">{{'hsbc-main.categorie_prof'|translate}}</div>\n                <div>\n                    <pib-dropdown \n                      [options]=\"eiProfessionalCategories\" \n                      [message]=\"_sharedModelService.model.informations.situation.professionalSituation.professionalCategoryError\" \n                      filteredList=\"true\"\n                      messageType=\"ERROR\"\n                      [stepSubmitted]=\"stepSubmitted\"\n                      (onChange)=\"_sharedModelService.model.informations.situation.professionalSituation.validateProfessionalCategory()\"\n                      [(ngModel)]=\"_sharedModelService.model.informations.situation.professionalSituation.professionalCategory\"\n                    ></pib-dropdown>\n                </div>\n            </div>\n            <div *ngIf=\"_sharedModelService.model.informations.situation.professionalSituation.professionalStatus === 'retraite'\" class=\"form__group\">\n                <div class=\"form__label\">{{'hsbc-main.categorie_prof'|translate}}</div>\n                <div>\n                    <pib-dropdown \n                      [options]=\"retirementProfessionalCategories\" \n                      [message]=\"_sharedModelService.model.informations.situation.professionalSituation.professionalCategoryError\" \n                      filteredList=\"true\"\n                      messageType=\"ERROR\"\n                      [stepSubmitted]=\"stepSubmitted\"\n                      (onChange)=\"_sharedModelService.model.informations.situation.professionalSituation.validateProfessionalCategory()\"\n                      [(ngModel)]=\"_sharedModelService.model.informations.situation.professionalSituation.professionalCategory\"\n                    ></pib-dropdown>\n                </div>\n            </div>\n            <div *ngIf=\"_sharedModelService.model.informations.situation.professionalSituation.professionalStatus === 'etudiant'\" class=\"form__group\">\n                <div class=\"form__label\">{{'hsbc-main.categorie_prof'|translate}}</div>\n                <div>\n                    <pib-dropdown \n                      [options]=\"studentProfessionalCategories\" \n                      [message]=\"_sharedModelService.model.informations.situation.professionalSituation.professionalCategoryError\" \n                      filteredList=\"true\"\n                      messageType=\"ERROR\"\n                      [stepSubmitted]=\"stepSubmitted\"\n                      (onChange)=\"_sharedModelService.model.informations.situation.professionalSituation.validateProfessionalCategory()\"\n                      [(ngModel)]=\"_sharedModelService.model.informations.situation.professionalSituation.professionalCategory\"\n                    ></pib-dropdown>\n                </div>\n            </div>\n            <div *ngIf=\"_sharedModelService.model.informations.situation.professionalSituation.professionalStatus !== 'retraite' && _sharedModelService.model.informations.situation.professionalSituation.professionalStatus !== 'etudiant' && _sharedModelService.model.informations.situation.professionalSituation.professionalStatus !== 'sans_profession'\">\n              <div *ngIf=\"_sharedModelService.model.informations.situation.professionalSituation.professionalStatus !== 'chef_entreprise'\" class=\"form__group\">\n                  <div class=\"form__label\">{{'hsbc-main.function'|translate}}</div>\n                  <div>\n                      <pib-text-field \n                        placeholder=\"Fonction\" \n                        (keyup)=\"_sharedModelService.model.informations.situation.professionalSituation.validateFunction($event)\"\n                        [stepSubmitted]=\"stepSubmitted\"\n                        [message]= \"_sharedModelService.model.informations.situation.professionalSituation.functionError\"\n                        [(ngModel)]=\"_sharedModelService.model.informations.situation.professionalSituation.function\"\n                      ></pib-text-field>\n                  </div>\n              </div>\n              <div class=\"form__group\">\n                  <div class=\"form__label\">{{'hsbc-main.activity_sector'|translate}}</div>\n                  <div>\n                      <pib-dropdown\n                        [options]=\"activitySectors\" \n                        [message]=\"_sharedModelService.model.informations.situation.professionalSituation.activitySectorError\"  messageType=\"ERROR\"\n                        [stepSubmitted]=\"stepSubmitted\"\n                        (onChange)=\"_sharedModelService.model.informations.situation.professionalSituation.validateActivitySector()\"\n                        [(ngModel)]=\"_sharedModelService.model.informations.situation.professionalSituation.activitySector\"\n                      ></pib-dropdown>\n                  </div>\n              </div>\n              <div class=\"form__group\">\n                  <div class=\"form__label\">{{'hsbc-main.employer'|translate}}</div>\n                  <div>\n                      <pib-text-field \n                        placeholder=\"{{'hsbc-main.employer'|translate}}\"\n                        (keyup)=\"_sharedModelService.model.informations.situation.professionalSituation.validateEmployer($event)\"\n                        [stepSubmitted]=\"stepSubmitted\"\n                        [message]= \"_sharedModelService.model.informations.situation.professionalSituation.employerError\"\n                        [(ngModel)]=\"_sharedModelService.model.informations.situation.professionalSituation.employer\"\n                      ></pib-text-field>\n                  </div>\n              </div>\n              <div class=\"form__group\">\n                  <div class=\"form__label\">{{'hsbc-main.employer_address'|translate}}</div>\n                  <div>\n                      <pib-text-field \n                        placeholder=\"{{'hsbc-main.employer_address'|translate}}\"\n                        (keyup)=\"_sharedModelService.model.informations.situation.professionalSituation.validateEmployerAddress($event)\"\n                        [stepSubmitted]=\"stepSubmitted\"\n                        [message]= \"_sharedModelService.model.informations.situation.professionalSituation.employerAddressError\"\n                        [(ngModel)]=\"_sharedModelService.model.informations.situation.professionalSituation.employerAddress\"\n                      ></pib-text-field>\n                  </div>\n              </div>\n              <div class=\"form__group\">\n                  <div class=\"form__label\">{{'hsbc-main.additional_address'|translate}}</div>\n                  <div>\n                      <pib-text-field placeholder=\"Adresse de l'employeur\" [(ngModel)]=\"adressEmployeur\"></pib-text-field>\n                  </div>\n              </div>\n              <div class=\"form__group clearfix\">\n                  <div class=\"grid__col--4 no-padding\">\n                      <div class=\"form__label\">\n                          {{'hsbc-main.postal_code'|translate}}\n                      </div>\n                      <div>\n                          <pib-text-field \n                            placeholder=\"{{'hsbc-main.postal_code'|translate}}\"\n                            (keyup)=\"_sharedModelService.model.informations.situation.professionalSituation.validateZipCode($event)\"\n                            [stepSubmitted]=\"stepSubmitted\"\n                            [message]= \"_sharedModelService.model.informations.situation.professionalSituation.zipCodeError\"\n                            [(ngModel)]=\"_sharedModelService.model.informations.situation.professionalSituation.zipCode\"\n                            ></pib-text-field>\n                      </div>\n                  </div>\n                  <div class=\"grid__col--8 \">\n                      <div class=\"form__label\">\n                          {{'hsbc-main.city'|translate}}\n                      </div>\n                      <div>\n                          <pib-text-field \n                            placeholder=\"{{'hsbc-main.nom'|translate}}\"\n                            (keyup)=\"_sharedModelService.model.informations.situation.professionalSituation.validateCity($event)\"\n                            [stepSubmitted]=\"stepSubmitted\"\n                            [message]= \"_sharedModelService.model.informations.situation.professionalSituation.cityError\"\n                            [(ngModel)]=\"_sharedModelService.model.informations.situation.professionalSituation.city\"\n                          ></pib-text-field>\n                      </div>\n                  </div>\n              </div>\n              <div class=\"form__group\">\n                  <div class=\"form__label\">{{'hsbc-main.countries'|translate}}</div>\n                  <div>\n                      <pib-dropdown [options]=\"countries\" \n                      [message]=\"_sharedModelService.model.informations.situation.professionalSituation.countryError\" messageType=\"ERROR\" \n                      [stepSubmitted]=\"stepSubmitted\"\n                      (onChange)=\"_sharedModelService.model.informations.situation.professionalSituation.validateCountry()\"\n                      [(ngModel)]=\"_sharedModelService.model.informations.situation.professionalSituation.country\"></pib-dropdown>\n                  </div>\n              </div>\n              <div class=\"form__group\">\n                  <div class=\"form__label\">{{'hsbc-main.employed_since'|translate}}</div>\n                  <div>\n                      <pib-calendar \n                      (keyup)=\"_sharedModelService.model.informations.situation.professionalSituation.validateArDate()\"\n                      [(ngModel)]=\"_sharedModelService.model.informations.situation.professionalSituation.atTheEemployerSince\" [showIcon]=\"true\" placeholder=\"{{'hsbc-main.date_format'|translate}}\"></pib-calendar>\n                  </div>\n              </div>\n              <div *ngIf=\"_sharedModelService.model.informations.situation.professionalSituation.atTheEemployerSinceError\" class=\"form__message form__message--error\" >\n                  <i class=\"icon icon-circle-delete\"></i> {{_sharedModelService.model.informations.situation.professionalSituation.atTheEemployerSinceError | translate}}\n              </div>\n            </div>\n            <div *ngIf=\"_sharedModelService.model.informations.situation.professionalSituation.professionalStatus === 'etudiant'\" class=\"form__group\">\n                <div class=\"form__label\">{{'hsbc-main.studies_end'|translate}} :</div>\n                <div>\n                    <pib-calendar \n                      [(ngModel)]=\"_sharedModelService.model.informations.situation.professionalSituation.atTheEemployerSince\"\n                      [showIcon]=\"true\"\n                      placeholder=\"{{'hsbc-main.date_format'|translate}}\"\n                      (keyup)=\"_sharedModelService.model.informations.situation.professionalSituation.validateArDate()\"\n                    ></pib-calendar>\n                </div>\n                <div *ngIf=\"_sharedModelService.model.informations.situation.professionalSituation.atTheEemployerSinceError\" class=\"form__message form__message--error\" >\n                  <i class=\"icon icon-circle-delete\"></i> {{_sharedModelService.model.informations.situation.professionalSituation.atTheEemployerSinceError | translate}}\n              </div>\n            </div>\n        </div>\n        <button pibButton type=\"button\" (click)=\"next()\" label=\"{{'hsbc-main.suivant' | translate}}\" class=\"btn--primary f-right\">\n                    </button>\n\n        <a (click)=\"goBack()\" class=\"btn--back\">{{'hsbc-main.retour'|translate}}</a>\n\n        <hr class=\"bottom-hr\"/>\n\n        <div class=\"f-right bottom-help\">\n            <i class=\"icon icon-circle-help\"></i> {{'hsbc-main.help' | translate}}\n        </div>\n    </div>\n</div>"
...
module.exports = "<div class=\"mt10 FEF__title sub\"> Récapitulatif et validation\n    <div class=\"mt10 FEF__subtitle\">\n        Merci de vérifier toutes vos informations avant d’e-signer votre contrat et mandat de mobilité bancaire.\n    </div>\n</div>\n<hr/>\n\n<div id=\"recap-inputs\">\n  Recap :\n\n  <!-- ============================================================================= -->\n  <!-- ================================ PERSONNAL INFO ============================= -->\n  <!-- ==================================== START ================================== -->\n  <!-- ============================================================================= -->\n  \n  <!-- ACCOUNT TYPE --> \n  {{_sharedModelService.model.accountType}} \n  <input \n    type=\"hidden\" \n    data-name=\"OtherUserDetails.AccountType\" \n    [value]=\"_sharedModelService.model.accountType === 'individual' ? 'S' : 'J'\"\n  />\n\n  <!-- CIVILITY --> \n  {{_sharedModelService.model.informations.person.civility}} \n  <input \n    type=\"hidden\" \n    data-name=\"PersonalData.Title\" \n    [value]=\"_sharedModelService.model.informations.person.civility\"\n  />\n  \n  <!-- FIRSTNAME --> \n  {{_sharedModelService.model.informations.person.firstName}} \n  <input \n    type=\"hidden\" \n    data-name=\"PersonalData.FirstName\" \n    [value]=\"_sharedModelService.model.informations.person.firstName\"\n  />\n  \n  <!-- LASTNAME  --> \n  {{_sharedModelService.model.informations.person.lastName}} \n  <input \n    type=\"hidden\" \n    data-name=\"PersonalData.LastName\" \n    [value]=\"_sharedModelService.model.informations.person.lastName\"\n  />\n\n  <!-- BIRTHDATE (with '/')  --> \n  {{_sharedModelService.model.informations.person.birthDate | date: 'dd/MM/yyyy'}} \n  <input \n    type=\"hidden\" \n    data-name=\"dateDeNaissance\" \n    [value]=\"_sharedModelService.model.informations.person.birthDate | date: 'dd/MM/yyyy'\"\n  />\n\n  <!-- BIRTHDATE (without '/')  --> \n  {{_sharedModelService.model.informations.person.birthDate | date: 'ddMMyyyy'}} \n  <input \n    type=\"hidden\" \n    data-name=\"TECHNICAL_NAME_dateDeNaissance\" \n    [value]=\"_sharedModelService.model.informations.person.birthDate | date: 'ddMMyyyy'\"\n  />\n\n  <!-- TECHNICAL_NAME_Date (current date with '/')  --> \n  {{currentDate | date: 'dd/MM/yyyy'}} \n  <input \n    type=\"hidden\" \n    data-name=\"TECHNICAL_NAME_Date\" \n    [value]=\"currentDate | date: 'dd/MM/yyyy'\"\n  />\n\n  <!-- TECHNICAL_NAME_Date bas de page (current date with '/')  --> \n  {{currentDate | date: 'dd/MM/yyyy - hh:mm'}} \n  <input \n    type=\"hidden\" \n    data-name=\"TECHNICAL_NAME_date bas de page\" \n    [value]=\"currentDate | date: 'dd/MM/yyyy - hh:mm'\"\n  />\n\n  <!-- EMAIL  --> \n  {{_sharedModelService.model.informations.person.email}} \n  <input \n    type=\"hidden\" \n    data-name=\"ContactData.HomeEmail\" \n    [value]=\"_sharedModelService.model.informations.person.email\"\n  />\n\n  <!-- MOBILE (without dial code) --> \n  {{_sharedModelService.model.informations.person.mobilePhone}} \n  <input \n    type=\"hidden\" \n    data-name=\"ContactData.MobilePager\"\n    [value]=\"_sharedModelService.model.informations.person.mobilePhone\"\n  />\n\n  <!-- MOBILE (with dial code) --> \n  {{_sharedModelService.model.informations.person.mobilePhoneDialCode  + _sharedModelService.model.informations.person.mobilePhone}} \n  <input \n    type=\"hidden\" \n    data-name=\"TECHNICAL_NAME_MobilePager\"\n    [value]=\"_sharedModelService.model.informations.person.mobilePhoneDialCode +_sharedModelService.model.informations.person.mobilePhone\"\n  />\n\n  <!-- FIXE (without dial code) --> \n  {{_sharedModelService.model.informations.person.fixePhone}} \n  <input\n    type=\"hidden\" \n    data-name=\"ContactData.HomePhone\"\n    *ngIf=\"_sharedModelService.model.informations.person.fixePhone\"\n    [value]=\"_sharedModelService.model.informations.person.fixePhone\"\n  />\n\n  <!-- FIXE (with dial code) --> \n  {{_sharedModelService.model.informations.person.fixePhoneDialCode + _sharedModelService.model.informations.person.fixePhone}} \n  <input\n    type=\"hidden\" \n    data-name=\"TECHNICAL_NAME_HomePhone\"\n    *ngIf=\"_sharedModelService.model.informations.person.fixePhone\"\n    [value]=\"_sharedModelService.model.informations.person.fixePhoneDialCode + _sharedModelService.model.informations.person.fixePhone\"\n  />\n\n  <!-- ACCEPT CONTACT EMAIL VALUE -->  \n  {{_sharedModelService.model.informations.person.contactMeByEmailOrSMS}} \n  <input\n    type=\"hidden\" \n    data-name=\"accept_contact_email\"\n    [value]=\"_sharedModelService.model.informations.person.contactMeByEmailOrSMS\"\n  />\n  \n  <!-- ACCEPT CONTACT EMAIL LABEL -->  \n  {{'hsbc-main.sms_check'|translate}} \n  <input\n    type=\"hidden\" \n    data-name=\"label_contactEmail\"\n    [value]=\"'hsbc-main.sms_check'|translate\"\n  />\n\n  <!-- ============================================================================= -->\n  <!-- ================================ DIRTY DATA ================================= -->\n  <!-- ============================================================================= -->\n\n\n  <!-- SITUATION LABEL -->  \n  <input\n    type=\"hidden\" \n    data-name=\"label_situation\"\n    [value]=\"'Célibataire'\"\n  />\n\n  <!-- SITUATION VALUE -->  \n  <input\n    type=\"hidden\" \n    data-name=\"DemographicData.MaritalStatus\"\n    [value]=\"1\"\n  />\n\n\n  <!-- MATRIMONIAL REGIME LABEL -->  \n  <input\n    type=\"hidden\" \n    data-name=\"label_regimeMatrimonial\"\n    [value]=\"'Communauté légale'\"\n  />\n\n  <!-- MATRIMONIAL REGIME VALUE -->  \n  <input\n    type=\"hidden\" \n    data-name=\"AdvanceData.RegimeMatrimonial\"\n    [value]=\"'CL'\"\n  />\n\n  <!-- NOM NAISSANCE -->  \n  <input\n    type=\"hidden\" \n    data-name=\"PersonalData.PatronymicName\"\n    [value]=\"'Beaudoin'\"\n  />\n\n  <!-- PAYS NAISSANCE -->  \n  <input\n    type=\"hidden\" \n    data-name=\"PersonalData.CountryOfBirth\"\n    [value]=\"'Beaudoin'\"\n  />\n\n  <!-- DEPARTEMENT NAISSANCE -->  \n  <input\n    type=\"hidden\" \n    data-name=\"PersonalData.DepartmentOfBirth\"\n    [value]=\"76000\"\n  />\n\n  <!-- VILLE NAISSANCE -->  \n  <input\n    type=\"hidden\" \n    data-name=\"PersonalData.TownOfBirth\"\n    [value]=\"'ROUEN'\"\n  />\n\n  <!-- NATIONALITE LABEL -->  \n  <input\n    type=\"hidden\" \n    data-name=\"label_Nationality\"\n    [value]=\"'FRANCE'\"\n  />\n\n  <!-- NATIONALITE VALUE -->  \n  <input\n    type=\"hidden\" \n    data-name=\"KeyJointData.Nationality\"\n    [value]=\"'FR'\"\n  />\n\n  <!-- NATIONALITE 2 LABEL -->  \n  <input\n    type=\"hidden\" \n    data-name=\"label_Nationality2\"\n    [value]=\"'FRANCE'\"\n  />\n\n  <!-- NATIONALITE 2 VALUE -->  \n  <input\n    type=\"hidden\" \n    data-name=\"nationalite_2\"\n    [value]=\"'FR'\"\n  />\n\n  <!-- NATIONALITE 3 LABEL -->  \n  <input\n    type=\"hidden\" \n    data-name=\"label_Nationality3\"\n    [value]=\"'FRANCE'\"\n  />\n\n  <!-- NATIONALITE 3 VALUE -->  \n  <input\n    type=\"hidden\" \n    data-name=\"nationalite_3\"\n    [value]=\"'FR'\"\n  />\n\n\n  <!-- IS US PERSON LABEL -->  \n  <input\n    type=\"hidden\" \n    data-name=\"label_USPerson\"\n    [value]=\"'Non'\"\n  />\n\n  <!-- IS US PERSON VALUE -->  \n  <input\n    type=\"hidden\" \n    data-name=\"AdvanceData.USPerson\"\n    [value]=\"false\"\n  />\n\n  <!-- ============================================================================= -->\n  <!-- ================================ PERSONNAL INFO ============================= -->\n  <!-- ==================================== END ==================================== -->\n  <!-- ============================================================================= -->\n\n\n\n  <!-- ============================================================================= -->\n  <!-- ================================ COORDONNEES ================================ -->\n  <!-- ================================== START ==================================== -->\n  <!-- ============================================================================= -->\n  \n  <!-- MAIN RESIDENCE ADRESS -->  \n  <input\n    type=\"hidden\" \n    data-name=\"ContactData.Address4\"\n    [value]=\"'18 avenue de la libération'\"\n  />\n\n  <!-- MAIN RESIDENCE COMP ADRESS -->  \n  <input\n    type=\"hidden\" \n    data-name=\"ContactData.Address2\"\n    [value]=\"'4ème étage'\"\n  />\n\n  <!-- MAIN RESIDENCE CP -->  \n  <input\n    type=\"hidden\" \n    data-name=\"hsbc_direct_registration.PostalCodeLocal\"\n    [value]=\"76000\"\n  />\n\n  <!-- MAIN RESIDENCE CITY -->  \n  <input\n    type=\"hidden\" \n    data-name=\"hsbc_direct_registration.CityLocal\"\n    [value]=\"ROUEN\"\n  />\n\n  <!-- MAIN RESIDENCE LABEL PAYS -->  \n  <input\n    type=\"hidden\" \n    data-name=\"label_pays\"\n    [value]=\"'FRANCE'\"\n  />\n\n  <!-- MAIN RESIDENCE VALUE PAYS -->  \n  <input\n    type=\"hidden\" \n    data-name=\"label_pays\"\n    [value]=\"'FR'\"\n  />\n\n  <!-- POSTAL RESIDENCE ADRESS -->  \n  <input\n    type=\"hidden\" \n    data-name=\"Address4_Courrier\"\n    [value]=\"'18 avenue de la libération'\"\n  />\n\n  <!-- POSTAL RESIDENCE COMP ADRESS -->  \n  <input\n    type=\"hidden\" \n    data-name=\"Address3_Courrier\"\n    [value]=\"'4ème étage'\"\n  />\n\n  <!-- POSTAL RESIDENCE CP -->  \n  <input\n    type=\"hidden\" \n    data-name=\"PostalCodeLocal_Courrier\"\n    [value]=\"76000\"\n  />\n\n  <!-- POSTAL RESIDENCE CITY -->  \n  <input\n    type=\"hidden\" \n    data-name=\"CityLocal_Courrier\"\n    [value]=\"ROUEN\"\n  />\n\n  <!-- POSTAL RESIDENCE LABEL PAYS -->  \n  <input\n    type=\"hidden\" \n    data-name=\"label_residenceCourrier\"\n    [value]=\"'FRANCE'\"\n  />\n\n  <!-- POSTAL RESIDENCE VALUE PAYS -->  \n  <input\n    type=\"hidden\" \n    data-name=\"residenceCourrier\"\n    [value]=\"'FR'\"\n  />\n\n  <!-- POSTAL RESIDENCE LABEL PAYS -->  \n  <input\n    type=\"hidden\" \n    data-name=\"TECHNICAL_NAME_ResidenceCourrier\"\n    [value]=\"'FRANCE'\"\n  />\n\n\n  <!-- PREVIOUS RESIDENCE ADRESS -->  \n  <input\n    type=\"hidden\" \n    data-name=\"CDD_adressePrecedente\"\n    [value]=\"'18 avenue de la libération'\"\n  />\n\n  <!-- PREVIOUS RESIDENCE COMP ADRESS -->  \n  <input\n    type=\"hidden\" \n    data-name=\"CDD_ComplementAdressePrecedente\"\n    [value]=\"'4ème étage'\"\n  />\n\n  <!-- PREVIOUS RESIDENCE CP -->  \n  <input\n    type=\"hidden\" \n    data-name=\"CDD_codePostalPrecedent\"\n    [value]=\"76000\"\n  />\n\n  <!-- PREVIOUS RESIDENCE CITY -->  \n  <input\n    type=\"hidden\" \n    data-name=\"CDD_villePrecedente\"\n    [value]=\"ROUEN\"\n  />\n\n  <!-- PREVIOUS RESIDENCE LABEL PAYS -->  \n  <input\n    type=\"hidden\" \n    data-name=\"label_CDD_paysPrecedent\"\n    [value]=\"'FRANCE'\"\n  />\n\n  <!-- PREVIOUS RESIDENCE VALUE PAYS -->  \n  <input\n    type=\"hidden\" \n    data-name=\"CDD_paysPrecedent\"\n    [value]=\"'FR'\"\n  />\n\n  <!-- PREVIOUS RESIDENCE LABEL PAYS -->  \n  <input\n    type=\"hidden\" \n    data-name=\"TECHNICAL_NAME_ResidenceCourrier\"\n    [value]=\"'FRANCE'\"\n  />\n\n\n  <!-- STATUT IMMO LABEL -->  \n  <input\n    type=\"hidden\" \n    data-name=\"label_statutimmo\"\n    [value]=\"'Locataire'\"\n  />\n\n  <!-- STATUT IMMO VALUE -->  \n  <input\n    type=\"hidden\" \n    data-name=\"StatutImmo\"\n    [value]=\"'LPP'\"\n  />\n\n  <!-- LIVE ADDRESS SINCE -->  \n  <input\n    type=\"hidden\" \n    data-name=\"TECHNICAL_NAME_Livingplace\"\n    [value]=\"'22/03/2010'\"\n  />\n\n  <!-- POSTAL ADDRESS IS DIFFERENT -->  \n  <input\n    type=\"hidden\" \n    data-name=\"adressepostalenotfiscale\"\n    [value]=\"false\"\n  />\n\n  <!-- ============================================================================= -->\n  <!-- ================================ COORDONNEES ================================ -->\n  <!-- ================================== END ====================================== -->\n  <!-- ============================================================================= -->\n  \n  \n  <!-- ============================================================================= -->\n  <!-- =========================  PROFESSIONAL SITUATION =========================== -->\n  <!-- ================================== START ==================================== -->\n  <!-- ============================================================================= -->\n  \n  <!-- PRO SITUATION LABEL -->  \n  <input\n    type=\"hidden\" \n    data-name=\"label_segmentpro\"\n    [value]=\"'Sans profession'\"\n  />\n\n  <!-- PRO SITUATION VALUE -->  \n  <input\n    type=\"hidden\" \n    data-name=\"SegmentPro\"\n    [value]=\"'sans_profession'\"\n  />\n\n  <!-- END STUDIES VALUE -->  \n  <input\n    type=\"hidden\" \n    data-name=\"CDD_dateFinEtudes\"\n    [value]=\"'10102012'\"\n  />\n\n  <!-- CATEGORIE PRO LABEL -->  \n  <input\n    type=\"hidden\" \n    data-name=\"label_CDD_statutPro\"\n    [value]=\"'Architecte'\"\n  />\n\n  <!-- CATEGORIE PRO VALUE -->  \n  <input\n    type=\"hidden\" \n    data-name=\"CDD_statutPro\"\n    [value]=\"26\"\n  /> \n\n  <!-- CONTRAT LABEL -->  \n  <input\n    type=\"hidden\" \n    data-name=\"label_contrat\"\n    [value]=\"'CDD'\"\n  />    \n\n  <!-- CONTRAT VALUE -->  \n  <input\n    type=\"hidden\" \n    data-name=\"Type_contrat\"\n    [value]=\"'D'\"\n  />\n\n\n  <!-- FONCTION -->  \n  <input\n    type=\"hidden\" \n    data-name=\"CDD_fonction\"\n    [value]=\"'test'\"\n  />\n\n  <!-- SECTEUR DACTIVITE LABEL -->  \n  <input\n    type=\"hidden\" \n    data-name=\"label_CDD_secteur_activite\"\n    [value]=\"'Activités informatiques'\"\n  />    \n\n  <!-- SECTEUR DACTIVITE VALUE -->  \n  <input\n    type=\"hidden\" \n    data-name=\"CDD_secteur_activite\"\n    [value]=\"1\"\n  />\n\n   <!-- NOM EMPLOYEUR -->  \n  <input\n    type=\"hidden\" \n    data-name=\"nomEmployeur\"\n    [value]=\"'TPZ'\"\n  />\n\n  <!-- ADRESSE EMPLOYEUR -->  \n  <input\n    type=\"hidden\" \n    data-name=\"CDD_adresseEmployeur\"\n    [value]=\"'11 rue des mathurins'\"\n  />\n\n  <!-- COMP ADRESSE EMPLOYEUR -->  \n  <input\n    type=\"hidden\" \n    data-name=\"CDD_ComplementAdresseEmployeur\"\n    [value]=\"'2ème étage'\"\n  />\n\n  <!-- CODE POSTAL EMPLOYEUR -->  \n  <input\n    type=\"hidden\" \n    data-name=\"CDD_codePostalEmployeur\"\n    [value]=\"76000\"\n  />\n\n  <!-- VILLE EMPLOYEUR -->  \n  <input\n    type=\"hidden\" \n    data-name=\"CDD_villeEmployeur\"\n    [value]=\"76000\"\n  />\n\n  <!-- PAYS EMPLOYEUR LABEL -->  \n  <input\n    type=\"hidden\" \n    data-name=\"label_CDD_paysEmployeur\"\n    [value]=\"'FRANCE'\"\n  />\n\n  <!-- PAYS EMPLOYEUR VALUE -->  \n  <input\n    type=\"hidden\" \n    data-name=\"CDD_paysEmployeur\"\n    [value]=\"'FR'\"\n  />\n\n  <!-- CHEZ EMPLOYEUR DEPUIS -->  \n  <input\n    type=\"hidden\" \n    data-name=\"chezEmployeur\"\n    [value]=\"'03052015'\"\n  />\n\n  <!-- ============================================================================= -->\n  <!-- =========================  PROFESSIONAL SITUATION =========================== -->\n  <!-- ================================== END  ===================================== -->\n  <!-- ============================================================================= -->\n\n  <!-- ============================================================================= -->\n  <!-- ===========================  MONTHLY INCOME ================================= -->\n  <!-- ================================ START  ===================================== -->\n  <!-- ============================================================================= -->\n  \n  <!-- SALAIRE MENSUELS -->  \n  <input\n    type=\"hidden\" \n    data-name=\"montantRevenu\"\n    [value]=\"3000\"\n  />\n\n  <!-- SALAIRE MENSUELS LABEL ???? -->  \n  <input\n    type=\"hidden\" \n    data-name=\"montantRevenu\"\n    [value]=\"'Lorem ipsum'\"\n  />\n\n  <!-- BNC -->  \n  <input\n    type=\"hidden\" \n    data-name=\"BNC\"\n    [value]=\"0\"\n  />\n\n  <!-- PENSION RETRAITE -->  \n  <input\n    type=\"hidden\" \n    data-name=\"revenus_retraite\"\n    [value]=\"0\"\n  />\n\n  <!-- ALLOCATION CHOMAGE -->  \n  <input\n    type=\"hidden\" \n    data-name=\"CDD_allocations_chomage\"\n    [value]=\"0\"\n  />\n\n  <!-- AUTRES REVENUS -->  \n  <input\n    type=\"hidden\" \n    data-name=\"autre_revenus\"\n    [value]=\"0\"\n  />\n\n  <!-- TOTAL REVENU TIT 1 -->  \n  <input\n    type=\"hidden\" \n    data-name=\"total_revenus_tit1\"\n    [value]=\"0\"\n  />\n\n  <!-- ============================================================================= -->\n  <!-- ===========================  MONTHLY INCOME ================================= -->\n  <!-- ================================== END  ===================================== -->\n  <!-- ============================================================================= -->\n  \n\n  <!-- ============================================================================= -->\n  <!-- ===========================  FISCAL INFOS =================================== -->\n  <!-- ================================== START  =================================== -->\n  <!-- ============================================================================= -->\n\n  <!-- LABEL FIRST FISCAL COUNTRY -->  \n  <input\n    type=\"hidden\" \n    data-name=\"label_FiscalCountryOfResidence\"\n    [value]=\"'FRANCE'\"\n  />\n\n  <!-- VALUE FIRST FISCAL COUNTRY -->  \n  <input\n    type=\"hidden\" \n    data-name=\"FiscalCountryOfResidence\"\n    [value]=\"'FR'\"\n  />\n\n  <!-- TIN FIRST COUNTRY -->  \n  <input\n    type=\"hidden\" \n    data-name=\"PersonalData.fiscalNumber\"\n    [value]=\"''\"\n  />\n\n  <!-- HAS NO TIN FIRST COUNTRY -->  \n  <input\n    type=\"hidden\" \n    data-name=\"label_crs_noNumber\"\n    [value]=\"true\"\n  />\n\n  <!-- MOTIF HAS NO TIN FIRST COUNTRY -->  \n  <input\n    type=\"hidden\" \n    data-name=\"CRSWhy_1\"\n    [value]=\"''\"\n  />\n\n  <!-- LABEL SECOND FISCAL COUNTRY -->  \n  <input\n    type=\"hidden\" \n    data-name=\"label_residenceFisc2\"\n    [value]=\"'FRANCE'\"\n  />\n\n  <!-- VALUE SECOND FISCAL COUNTRY -->  \n  <input\n    type=\"hidden\" \n    data-name=\"FiscalCountryOfResidence_2\"\n    [value]=\"'FR'\"\n  />\n\n  <!-- TIN SECOND COUNTRY -->  \n  <input\n    type=\"hidden\" \n    data-name=\"TIN_2\"\n    [value]=\"''\"\n  />\n\n  <!-- HAS NO TIN SECOND COUNTRY -->  \n  <input\n    type=\"hidden\" \n    data-name=\"label_crsNoNum_2\"\n    [value]=\"true\"\n  />\n\n  <!-- MOTIF HAS NO TIN SECOND COUNTRY -->  \n  <input\n    type=\"hidden\" \n    data-name=\"CRSWhy_2\"\n    [value]=\"''\"\n  />\n\n\n  <!-- LABEL THIRD FISCAL COUNTRY -->  \n  <input\n    type=\"hidden\" \n    data-name=\"label_residenceFisc3\"\n    [value]=\"'FRANCE'\"\n  />\n\n  <!-- VALUE THIRD FISCAL COUNTRY -->  \n  <input\n    type=\"hidden\" \n    data-name=\"FiscalCountryOfResidence_3\"\n    [value]=\"'FR'\"\n  />\n\n  <!-- TIN THIRD COUNTRY -->  \n  <input\n    type=\"hidden\" \n    data-name=\"TIN_3\"\n    [value]=\"''\"\n  />\n\n  <!-- HAS NO TIN THIRD COUNTRY -->  \n  <input\n    type=\"hidden\" \n    data-name=\"label_crsNoNum_3\"\n    [value]=\"true\"\n  />\n\n  <!-- MOTIF HAS NO TIN THIRD COUNTRY -->  \n  <input\n    type=\"hidden\" \n    data-name=\"CRSWhy_3\"\n    [value]=\"''\"\n  />\n\n  <!-- ============================================================================= -->\n  <!-- ===========================  FISCAL INFOS =================================== -->\n  <!-- ================================= END ======================================= -->\n  <!-- ============================================================================= -->\n\n  <!-- ============================================================================= -->\n  <!-- ==============================  PATRIMONY =================================== -->\n  <!-- ================================= START ===================================== -->\n  <!-- ============================================================================= -->\n\n  <!-- LABEL REVENUS -->  \n  <input\n    type=\"hidden\" \n    data-name=\"label_revenu\"\n    [value]=\"'Non'\"\n  />\n\n  <!-- LABEL HERITAGE -->  \n  <input\n    type=\"hidden\" \n    data-name=\"label_heritage\"\n    [value]=\"'Non'\"\n  />\n\n  <!-- LABEL DONATION -->  \n  <input\n    type=\"hidden\" \n    data-name=\"label_donation\"\n    [value]=\"'Non'\"\n  />\n\n  <!-- LABEL GAIN -->  \n  <input\n    type=\"hidden\" \n    data-name=\"label_gain\"\n    [value]=\"'Non'\"\n  />\n\n  <!-- LABEL NO PATRIMONY -->  \n  <input\n    type=\"hidden\" \n    data-name=\"label_nopatrimoine\"\n    [value]=\"'I have no asset'\"\n  />\n\n  <!-- LABEL PATRIMONY -->  \n  <input\n    type=\"hidden\" \n    data-name=\"label_patrimoine\"\n    [value]=\"'I have asset'\"\n  />\n\n  <!-- LABEL ORIGIN PATRIMONY 1 -->  \n  <input\n    type=\"hidden\" \n    data-name=\"label_CDD_Origine_Patrimoine1\"\n    [value]=\"'FRANCE'\"\n  />\n\n  <!-- VALUE ORIGIN PATRIMONY 1 -->  \n  <input\n    type=\"hidden\" \n    data-name=\"CDD_Origine_Patrimoine1\"\n    [value]=\"'FR'\"\n  />\n\n  <!-- LABEL ORIGIN PATRIMONY 2 -->  \n  <input\n    type=\"hidden\" \n    data-name=\"label_CDD_Origine_Patrimoine2\"\n    [value]=\"''\"\n  />\n\n  <!-- VALUE ORIGIN PATRIMONY 2 -->  \n  <input\n    type=\"hidden\" \n    data-name=\"CDD_Origine_Patrimoine2\"\n    [value]=\"'FR'\"\n  />\n\n  <!-- LABEL ORIGIN PATRIMONY 3 -->  \n  <input\n    type=\"hidden\" \n    data-name=\"label_CDD_Origine_Patrimoine3\"\n    [value]=\"''\"\n  />\n\n  <!-- VALUE ORIGIN PATRIMONY 3 -->  \n  <input\n    type=\"hidden\" \n    data-name=\"CDD_Origine_Patrimoine3\"\n    [value]=\"'FR'\"\n  />\n\n  <!-- LABEL COMPTE EPARGNE -->  \n  <input\n    type=\"hidden\" \n    data-name=\"label_compteEpargne\"\n    [value]=\"'De 0 à 1000 €'\"\n  />\n\n  <!-- VALUE COMPTE EPARGNE -->  \n  <input\n    type=\"hidden\" \n    data-name=\"compteEpargne\"\n    [value]=\"0\"\n  />\n\n  <!-- LABEL COMPTE EPARGNE -->  \n  <input\n    type=\"hidden\" \n    data-name=\"label_compteEpargne\"\n    [value]=\"'De 0 à 1000 €'\"\n  />\n\n  <!-- VALUE COMPTE EPARGNE -->  \n  <input\n    type=\"hidden\" \n    data-name=\"compteEpargne\"\n    [value]=\"0\"\n  />\n\n  <!-- LABEL TITRES PROPRIETE -->  \n  <input\n    type=\"hidden\" \n    data-name=\"label_propertyTitles\"\n    [value]=\"'De 0 à 1000 €'\"\n  />\n\n  <!-- VALUE TITRES PROPRIETE -->  \n  <input\n    type=\"hidden\" \n    data-name=\"propertyTitles\"\n    [value]=\"0\"\n  />\n\n  <!-- LABEL ASSURANCES -->  \n  <input\n    type=\"hidden\" \n    data-name=\"label_assurance\"\n    [value]=\"'De 0 à 1000 €'\"\n  />\n\n  <!-- VALUE ASSURANCES -->  \n  <input\n    type=\"hidden\" \n    data-name=\"assurance-vie\"\n    [value]=\"0\"\n  />\n\n  <!-- LABEL AUTRES -->  \n  <input\n    type=\"hidden\" \n    data-name=\"CptAutre\"\n    [value]=\"'De 0 à 1000 €'\"\n  />\n\n  <!-- VALUE AUTRES -->  \n  <input\n    type=\"hidden\" \n    data-name=\"autres\"\n    [value]=\"0\"\n  />\n\n  <!-- VALUE MAIN RESIDENCE -->  \n  <input\n    type=\"hidden\" \n    data-name=\"mainHome\"\n    [value]=\"0\"\n  />\n\n  <!-- VALUE OTHER IMMO -->  \n  <input\n    type=\"hidden\" \n    data-name=\"placementImmobilier\"\n    [value]=\"0\"\n  />\n\n  <!-- NO PATRIMONY -->  \n  <input\n    type=\"hidden\" \n    data-name=\"nopatrimoine\"\n    [value]=\"false\"\n  />\n\n\n  <!-- ============================================================================= -->\n  <!-- ==============================  PATRIMONY =================================== -->\n  <!-- ================================== END  ===================================== -->\n  <!-- ============================================================================= -->\n\n\n  <!-- ============================================================================= -->\n  <!-- ============================  FOLLOW ACCOUNT ================================ -->\n  <!-- ================================= START  ==================================== -->\n  <!-- ============================================================================= -->\n\n  <!-- LABEL AGENCE -->  \n  <input\n    type=\"hidden\" \n    data-name=\"label_agence\"\n    [value]=\"'Agence directe'\"\n  />\n\n  <!-- VALUE AGENCE -->  \n  <input\n    type=\"hidden\" \n    data-name=\"AdvanceData.gestionMode\"\n    [value]=\"'I'\"\n  />\n\n  <!-- AGENCE NUM -->  \n  <input\n    type=\"hidden\" \n    data-name=\"Customer1HubSubConstants.BranchCode\"\n    [value]=\"''\"\n  />\n\n  <!-- VALUE TYPE AGENCE -->  \n  <input\n    type=\"hidden\" \n    data-name=\"Type_Agence\"\n    [value]=\"'Directe'\"\n  />\n\n  <!-- ============================================================================= -->\n  <!-- ============================  FOLLOW ACCOUNT ================================ -->\n  <!-- =================================== END  ==================================== -->\n  <!-- ============================================================================= -->\n\n  <!-- ============================================================================= -->\n  <!-- ==============================  YOUR ACCOUNT ================================ -->\n  <!-- ================================= START  ==================================== -->\n  <!-- ============================================================================= -->\n  \n  <!-- VALUE CONVENTION -->  \n  <input\n    type=\"hidden\" \n    data-name=\"AdvanceData.Convention\"\n    [value]=\"2\"\n  />\n\n\n  <!-- LABEL HEXAGONE -->  \n  <input\n    type=\"hidden\" \n    data-name=\"label_hexagone\"\n    [value]=\"'NON'\"\n  />\n\n  <!-- CONVENTION CHOISIE ??? -->  \n  <input\n    type=\"hidden\" \n    data-name=\"convention_choisie\"\n    [value]=\"'NON'\"\n  />\n\n  <!-- FREE 2 ??? VALUE FACILITE CAISSE -->  \n  <input\n    type=\"hidden\" \n    data-name=\"free_2\"\n    [value]=\"false\"\n  />\n\n  <!-- LABEL FACILITE CAISSE -->  \n  <input\n    type=\"hidden\" \n    data-name=\"label_faciliteCaisse\"\n    [value]=\"'NON'\"\n  />\n\n  <!-- LABEL EMISSION VIREMENT INTER -->  \n  <input\n    type=\"hidden\" \n    data-name=\"CDD_reponse_emissonVirementInter\"\n    [value]=\"'NON'\"\n  />\n\n  <!-- LABEL RECEPTION VIREMENT INTER -->  \n  <input\n    type=\"hidden\" \n    data-name=\"noVirementInter\"\n    [value]=\"0\"\n  />\n\n  <!-- noVirementInter ??? -->  \n  <input\n    type=\"hidden\" \n    data-name=\"CDD_reponse_receptionVirementInter\"\n    [value]=\"'NON'\"\n  />\n\n  <!-- LABEL COUNTRY EMISSION VIREMENT 1 -->  \n  <input\n    type=\"hidden\" \n    data-name=\"label_CDD_countryEmissionVir1\"\n    [value]=\"'FRANCE'\"\n  />\n\n  <!-- VALUE COUNTRY EMISSION VIREMENT 1 -->  \n  <input\n    type=\"hidden\" \n    data-name=\"CDD_countryEmissionVir1\"\n    [value]=\"'FR'\"\n  />\n\n  <!-- LABEL COUNTRY EMISSION VIREMENT 2 -->  \n  <input\n    type=\"hidden\" \n    data-name=\"label_CDD_countryEmissionVir2\"\n    [value]=\"'FRANCE'\"\n  />\n\n  <!-- VALUE COUNTRY EMISSION VIREMENT 2 -->  \n  <input\n    type=\"hidden\" \n    data-name=\"CDD_countryEmissionVir2\"\n    [value]=\"'FR'\"\n  />\n\n  <!-- LABEL COUNTRY EMISSION VIREMENT 3 -->  \n  <input\n    type=\"hidden\" \n    data-name=\"label_CDD_countryEmissionVir3\"\n    [value]=\"'FRANCE'\"\n  />\n\n  <!-- VALUE COUNTRY EMISSION VIREMENT 3 -->  \n  <input\n    type=\"hidden\" \n    data-name=\"CDD_countryEmissionVir3\"\n    [value]=\"'FR'\"\n  />\n\n  <!-- VALUE NOMBRE EMISSION VIREMENT -->  \n  <input\n    type=\"hidden\" \n    data-name=\"CDD_nombreEmissionVir\"\n    [value]=\"3\"\n  />\n\n  <!-- VALUE MOTIF EMISSION VIREMENT -->  \n  <input\n    type=\"hidden\" \n    data-name=\"CDD_motifEmissionVir\"\n    [value]=\"'Pour envoyer de l\\'argent'\"\n  />\n\n  <!-- VALUE MONTANT EMISSION VIREMENT -->  \n  <input\n    type=\"hidden\" \n    data-name=\"CDD_montantEmissionVir\"\n    [value]=\"5000\"\n  />\n\n  <!-- LABEL COUNTRY RECEPTION VIREMENT 1 -->  \n  <input\n    type=\"hidden\" \n    data-name=\"label_CDD_countryReceptionVir1\"\n    [value]=\"'FRANCE'\"\n  />\n\n  <!-- VALUE COUNTRY RECEPTION VIREMENT 1 -->  \n  <input\n    type=\"hidden\" \n    data-name=\"CDD_countryReceptionVir1\"\n    [value]=\"'FR'\"\n  />\n\n  <!-- LABEL COUNTRY RECEPTION VIREMENT 2 -->  \n  <input\n    type=\"hidden\" \n    data-name=\"label_CDD_countryReceptionVir2\"\n    [value]=\"'FRANCE'\"\n  />\n\n  <!-- VALUE COUNTRY RECEPTION VIREMENT 2 -->  \n  <input\n    type=\"hidden\" \n    data-name=\"CDD_countryReceptionVir2\"\n    [value]=\"'FR'\"\n  />\n\n  <!-- LABEL COUNTRY RECEPTION VIREMENT 3 -->  \n  <input\n    type=\"hidden\" \n    data-name=\"label_CDD_countryReceptionVir3\"\n    [value]=\"'FRANCE'\"\n  />\n\n  <!-- VALUE COUNTRY RECEPTION VIREMENT 3 -->  \n  <input\n    type=\"hidden\" \n    data-name=\"CDD_countryReceptionVir3\"\n    [value]=\"'FR'\"\n  />\n\n  <!-- VALUE NOMBRE RECEPTION VIREMENT -->  \n  <input\n    type=\"hidden\" \n    data-name=\"CDD_nombreReceptionVir\"\n    [value]=\"3\"\n  />\n\n  <!-- VALUE MOTIF RECEPTION VIREMENT -->  \n  <input\n    type=\"hidden\" \n    data-name=\"CDD_motifReceptionVir\"\n    [value]=\"'Pour envoyer de l\\'argent'\"\n  />\n\n  <!-- VALUE MONTANT RECEPTION VIREMENT -->  \n  <input\n    type=\"hidden\" \n    data-name=\"CDD_montantReceptionVir\"\n    [value]=\"5000\"\n  />\n\n  <!-- ============================================================================= -->\n  <!-- ==============================  YOUR ACCOUNT ================================ -->\n  <!-- ================================= END  ====================================== -->\n  <!-- ============================================================================= -->\n  \n  <!-- ============================================================================= -->\n  <!-- ================================  CARD TYPE ================================ -->\n  <!-- ================================== START  ================================== -->\n  <!-- ============================================================================= -->\n  \n  <!-- LABEL DEBIT -->  \n  <input\n    type=\"hidden\" \n    data-name=\"label_debit\"\n    [value]=\"'Débit différé'\"\n  />\n  \n  <!-- VALUE CARD TYPE -->  \n  <input\n    type=\"hidden\" \n    data-name=\"AdvanceData.CardType\"\n    [value]=\"1\"\n  />\n\n  <!-- LABEL CARD TYPE -->  \n  <input\n    type=\"hidden\" \n    data-name=\"label_cb\"\n    [value]=\"'Carte Visa Classic'\"\n  />\n\n  <!-- CardVisa -->  \n  <input\n    type=\"hidden\" \n    data-name=\"CardVisa\"\n    [value]=\"false\"\n  />\n\n  <!-- CardVisaPremier -->  \n  <input\n    type=\"hidden\" \n    data-name=\"CardVisaPremier\"\n    [value]=\"false\"\n  />\n\n  <!-- CardMaster -->  \n  <input\n    type=\"hidden\" \n    data-name=\"CardMaster\"\n    [value]=\"false\"\n  />\n\n  <!-- LABEL NO CB -->  \n  <input\n    type=\"hidden\" \n    data-name=\"label_no_cb\"\n    [value]=\"'Je ne veux pas souscrire de carte.'\"\n  />\n\n  <!-- VALUE NO CB -->  \n  <input\n    type=\"hidden\" \n    data-name=\"value_no_cb\"\n    [value]=\"1\"\n  />\n\n  <!-- ============================================================================= -->\n  <!-- ================================  CARD TYPE ================================ -->\n  <!-- ================================== END  ================================== -->\n  <!-- ============================================================================= -->\n\n  <!-- ============================================================================= -->\n  <!-- ============================= CARD UTILISATION ============================== -->\n  <!-- ================================== START  =================================== -->\n  <!-- ============================================================================= -->\n  \n  <!-- LABEL DOMICILIATION -->  \n  <input\n    type=\"hidden\" \n    data-name=\"label_domiciliation\"\n    [value]=\"'No'\"\n  />\n\n  <!-- VALUE DOMICILIATION -->  \n  <input\n    type=\"hidden\" \n    data-name=\"Domiciliation\"\n    [value]=\"2\"\n  />\n\n  <!-- IBAN ORIGIN -->  \n  <input\n    type=\"hidden\" \n    data-name=\"IBANOrigine\"\n    [value]=\"''\"\n  />\n\n  <!-- LABEL ORDRE VIREMENT PERMANENT -->  \n  <input\n    type=\"hidden\" \n    data-name=\"label_ordre_virement_permanent\"\n    [value]=\"'NON'\"\n  />\n\n  <!-- VALUE NOMBRE JOURS TRANSFERT -->  \n  <input\n    type=\"hidden\" \n    data-name=\"nombreJoursTransfert\"\n    [value]=\"2\"\n  />\n\n  <!-- LABEL CLOTURE ANCIEN COMPTE -->  \n  <input\n    type=\"hidden\" \n    data-name=\"label_ordre_virement_permanent\"\n    [value]=\"'NON'\"\n  />\n\n  <!-- VALUE NOMBRE JOURS CLOTURE ANCIEN COMPTE -->  \n  <input\n    type=\"hidden\" \n    data-name=\"nombreJoursCloture\"\n    [value]=\"'NON'\"\n  />\n\n  <!-- LABEL UTILISATION COMPTE -->  \n  <input\n    type=\"hidden\" \n    data-name=\"label_utilisationCompte\"\n    [value]=\"'Compte principal'\"\n  />\n\n  <!-- VALUE UTILISATION COMPTE -->  \n  <input\n    type=\"hidden\" \n    data-name=\"utilisationCompte\"\n    [value]=\"1\"\n  />\n\n  <!-- LABEL MONTANT CONFIE MENSUEL ??? -->  \n  <input\n    type=\"hidden\" \n    data-name=\"label_CDD_montantConfieMensuel\"\n    [value]=\"'Moins de 409'\"\n  />\n\n  <!-- VALUE MONTANT CONFIE MENSUEL ??? -->  \n  <input\n    type=\"hidden\" \n    data-name=\"CDD_montantConfieMensuel\"\n    [value]=\"299\"\n  />\n\n  <!-- VALUE CHOIX DOM JOINT ??? -->  \n  <input\n    type=\"hidden\" \n    data-name=\"choix_dom_joint\"\n    [value]=\"\"\n  />\n\n  <!-- INTITULE ORIGINE ??? -->  \n  <input\n    type=\"hidden\" \n    data-name=\"IntituleOrigine\"\n    [value]=\"\"\n  />\n\n  <!-- TECHMOB_Nom ??? -->  \n  <input\n    type=\"hidden\" \n    data-name=\"TECHMOB_Nom\"\n    [value]=\"\"\n  />\n\n  <!-- TECHMOB_Prenom ??? -->  \n  <input\n    type=\"hidden\" \n    data-name=\"TECHMOB_Prenom\"\n    [value]=\"\"\n  />\n\n  <!-- TECHMOB_Pays_de_naissance ??? -->  \n  <input\n    type=\"hidden\" \n    data-name=\"TECHMOB_Pays_de_naissance\"\n    [value]=\"\"\n  />\n\n  <!-- TECHMOB_Date_de_naissance ??? -->  \n  <input\n    type=\"hidden\" \n    data-name=\"TECHMOB_Date_de_naissance\"\n    [value]=\"\"\n  />\n\n  <!-- TECHMOB_Prenom ??? -->  \n  <input\n    type=\"hidden\" \n    data-name=\"TECHMOB_Prenom\"\n    [value]=\"\"\n  />\n\n  <!-- TECHMOB_Prenom ??? -->  \n  <input\n    type=\"hidden\" \n    data-name=\"TECHMOB_Prenom\"\n    [value]=\"\"\n  />\n\n  <!-- TECHMOB_Ville_de_naissance ??? -->  \n  <input\n    type=\"hidden\" \n    data-name=\"TECHMOB_Ville_de_naissance\"\n    [value]=\"\"\n  />\n\n  <!-- TECHMOB_Numero_de_voie ??? -->  \n  <input\n    type=\"hidden\" \n    data-name=\"TECHMOB_Numero_de_voie\"\n    [value]=\"\"\n  />\n\n  <!-- TECHMOB_Code_postal ??? -->  \n  <input\n    type=\"hidden\" \n    data-name=\"TECHMOB_Code_postal\"\n    [value]=\"\"\n  />\n\n  <!-- TECHMOB_Commune ??? -->  \n  <input\n    type=\"hidden\" \n    data-name=\"TECHMOB_Commune\"\n    [value]=\"\"\n  />\n\n  <!-- TECHMOB_Pays ??? -->  \n  <input\n    type=\"hidden\" \n    data-name=\"TECHMOB_Pays\"\n    [value]=\"\"\n  />\n\n  <!-- TECHMOB_Email ??? -->  \n  <input\n    type=\"hidden\" \n    data-name=\"TECHMOB_Email\"\n    [value]=\"\"\n  />\n\n  <!-- TECHMOB_Telephone_autre ??? -->  \n  <input\n    type=\"hidden\" \n    data-name=\"TECHMOB_Telephone_autre\"\n    [value]=\"\"\n  />\n\n  <!-- TECHMOB_Telephone_mobile ??? -->  \n  <input\n    type=\"hidden\" \n    data-name=\"TECHMOB_Telephone_mobile\"\n    [value]=\"\"\n  />\n\n  <!-- LABEL CONTACT REJET CHEQUE  -->  \n  <input\n    type=\"hidden\" \n    data-name=\"label_contact_rejet_cheque\"\n    [value]=\"'telephone'\"\n  />\n\n  <!-- VALUE CONTACT REJET CHEQUE -->  \n  <input\n    type=\"hidden\"\n    data-name=\"contact_rejet_cheque\"\n    [value]=\"'email'\"\n  />\n\n  <!-- ============================================================================= -->\n  <!-- ============================= CARD UTILISATION ============================== -->\n  <!-- ==================================== END  =================================== -->\n  <!-- ============================================================================= -->\n\n</div>\n\n<div class=\"clearfix mt40\">\n    <div class=\"grid__col--8 no-padding\">\n        <div>\n            <div style=\"margin-bottom:35px;\">N’hésitez pas à les modifier en cas d’erreur ou d’oubli.</div>\n            <div class=\"user-infos\">\n                <div>\n                    {{_sharedModelService.model.informations.person.firstName }} {{_sharedModelService.model.informations.person.lastName }}\n                </div>\n                <div>\n                    {{_sharedModelService.model.informations.person.mobilePhone }}\n                </div>\n                <div>\n                    {{_sharedModelService.model.informations.person.email }}\n                </div>\n            </div>\n            <div>\n                <a>\n                  Modifier <i class=\"icon icon-chevron-right\" style=\"color: #DA0010;\"></i>\n                </a>\n            </div>\n        </div>\n        <div class=\"mt40 expandable__row\" (click)=\"expand('information')\">Vos informations <i class=\"icon f-right\" [ngClass]=\"{'icon-chevron-up':expanded == 'information','icon-chevron-down':expanded !== 'information'}\"></i></div>\n        <hr/>\n        <div *ngIf=\"expanded == 'information'\">\n            <div class=\"modify-info\" style=\"text-align:right;\">\n                <a><i class=\"icon icon-edit\"></i> Edit</a>\n            </div>\n            <div class=\"panel panel--form\">\n\n                <table class=\"modify-info__table\">\n                    <tr>\n                        <td>Civilité</td>\n                        <td>{{_sharedModelService.model.informations.person.civility }}</td>\n                    </tr>\n                    <tr>\n                        <td>Nom</td>\n                        <td>{{_sharedModelService.model.informations.person.lastName }}</td>\n                    </tr>\n                    <tr>\n                        <td>Prénom</td>\n                        <td>{{_sharedModelService.model.informations.person.firstName }}</td>\n                    </tr>\n                    <tr>\n                        <td>Situation familiale</td>\n                        <td>{{_sharedModelService.model.informations.person.familySituation }}</td>\n                    </tr>\n                    <tr>\n                        <td>Régime matrimonial</td>\n                        <td>{{_sharedModelService.model.informations.person.MaritalStatus }}</td>\n                    </tr>\n                    <tr>\n                        <td>Nom de naissance</td>\n                        <td>{{_sharedModelService.model.informations.person.birthName }}</td>\n                    </tr>\n                    <tr>\n                        <td>Date de naissance</td>\n                        <td>{{_sharedModelService.model.informations.person.birthDate | date: 'dd/MM/yyyy'}}</td>\n                    </tr>\n                    <tr>\n                        <td>Pays de naissance</td>\n                        <td>{{_sharedModelService.model.informations.person.birthCountry }}</td>\n                    </tr>\n                    <tr>\n                        <td>Ville de naissance</td>\n                        <td>{{_sharedModelService.model.informations.person.birthCountry }}</td>\n                    </tr>\n                    <tr>\n                        <td>Nationalité</td>\n                        <td>{{_sharedModelService.model.informations.person.nationality }}</td>\n                    </tr>\n                    <tr *ngFor=\"let nat of _sharedModelService.model.informations.person.otherNationalities;let i = index;\">\n                        <td>{{numbersAsLetters[i]}} nationalité</td>\n                        <td>{{nat}}</td>\n                    </tr>\n                    <tr>\n                        <td>US Person</td>\n                        <td>{{_sharedModelService.model.informations.person.isUsPerson ? 'OUi':'Non' }}</td>\n                    </tr>\n                </table>\n            </div>\n            <hr/>\n        </div>\n\n        <div class=\"expandable__row\" (click)=\"expand('situation')\">Votre situation <i class=\"icon f-right\" [ngClass]=\"{'icon-chevron-up':expanded == 'situation','icon-chevron-down':expanded !== 'situation'}\"></i></div>\n        <hr/>\n        <div *ngIf=\"expanded == 'situation'\">\n            <div class=\"modify-info\" style=\"text-align:right;\">\n                <a><i class=\"icon icon-edit\"></i> Edit</a>\n            </div>\n            <div class=\"panel panel--form\">\n\n                <table class=\"modify-info__table\">\n                    <tr>\n                        <td>Civilité</td>\n                        <td>{{_sharedModelService.model.informations.person.civility }}</td>\n                    </tr>\n                    <tr>\n                        <td>Nom</td>\n                        <td>{{_sharedModelService.model.informations.person.lastName }}</td>\n                    </tr>\n                    <tr>\n                        <td>Prénom</td>\n                        <td>{{_sharedModelService.model.informations.person.firstName }}</td>\n                    </tr>\n                    <tr>\n                        <td>Situation familiale</td>\n                        <td>{{_sharedModelService.model.informations.person.familySituation }}</td>\n                    </tr>\n                    <tr>\n                        <td>Régime matrimonial</td>\n                        <td>{{_sharedModelService.model.informations.person.MaritalStatus }}</td>\n                    </tr>\n                    <tr>\n                        <td>Nom de naissance</td>\n                        <td>{{_sharedModelService.model.informations.person.birthName }}</td>\n                    </tr>\n                    <tr>\n                        <td>Date de naissance</td>\n                        <td>{{_sharedModelService.model.informations.person.birthDate }}</td>\n                    </tr>\n                    <tr>\n                        <td>Pays de naissance</td>\n                        <td>{{_sharedModelService.model.informations.person.birthCountry }}</td>\n                    </tr>\n                    <tr>\n                        <td>Ville de naissance</td>\n                        <td>{{_sharedModelService.model.informations.person.birthCountry }}</td>\n                    </tr>\n                    <tr>\n                        <td>Nationalité</td>\n                        <td>{{_sharedModelService.model.informations.person.nationality }}</td>\n                    </tr>\n                    <tr *ngFor=\"let nat of _sharedModelService.model.informations.person.otherNationalities;let i = index;\">\n                        <td>{{numbersAsLetters[i]}} nationalité</td>\n                        <td>{{nat}}</td>\n                    </tr>\n                    <tr>\n                        <td>US Person</td>\n                        <td>{{_sharedModelService.model.informations.person.isUsPerson ? 'OUi':'Non' }}</td>\n                    </tr>\n                </table>\n            </div>\n            <hr/>\n        </div>\n\n        <div class=\"expandable__row\" (click)=\"expand('account')\">Votre Compte <i class=\"icon f-right\" [ngClass]=\"{'icon-chevron-up':expanded == 'account','icon-chevron-down':expanded !== 'account'}\"></i></div>\n        <hr/>\n        <div *ngIf=\"expanded == 'account'\">\n            <div class=\"modify-info\" style=\"text-align:right;\">\n                <a><i class=\"icon icon-edit\"></i> Edit</a>\n            </div>\n\n            <div class=\"panel panel--form\">\n                \n                <table class=\"modify-info__table\">\n                    <tr>\n                        <td>Civilité</td>\n                        <td>{{_sharedModelService.model.informations.person.civility }}</td>\n                    </tr>\n                    <tr>\n                        <td>Nom</td>\n                        <td>{{_sharedModelService.model.informations.person.lastName }}</td>\n                    </tr>\n                    <tr>\n                        <td>Prénom</td>\n                        <td>{{_sharedModelService.model.informations.person.firstName }}</td>\n                    </tr>\n                    <tr>\n                        <td>Situation familiale</td>\n                        <td>{{_sharedModelService.model.informations.person.familySituation }}</td>\n                    </tr>\n                    <tr>\n                        <td>Régime matrimonial</td>\n                        <td>{{_sharedModelService.model.informations.person.MaritalStatus }}</td>\n                    </tr>\n                    <tr>\n                        <td>Nom de naissance</td>\n                        <td>{{_sharedModelService.model.informations.person.birthName }}</td>\n                    </tr>\n                    <tr>\n                        <td>Date de naissance</td>\n                        <td>{{_sharedModelService.model.informations.person.birthDate }}</td>\n                    </tr>\n                    <tr>\n                        <td>Pays de naissance</td>\n                        <td>{{_sharedModelService.model.informations.person.birthCountry }}</td>\n                    </tr>\n                    <tr>\n                        <td>Ville de naissance</td>\n                        <td>{{_sharedModelService.model.informations.person.birthCountry }}</td>\n                    </tr>\n                    <tr>\n                        <td>Nationalité</td>\n                        <td>{{_sharedModelService.model.informations.person.nationality }}</td>\n                    </tr>\n                    <tr *ngFor=\"let nat of _sharedModelService.model.informations.person.otherNationalities;let i = index;\">\n                        <td>{{numbersAsLetters[i]}} nationalité</td>\n                        <td>{{nat}}</td>\n                    </tr>\n                    <tr>\n                        <td>US Person</td>\n                        <td>{{_sharedModelService.model.informations.person.isUsPerson ? 'OUi':'Non' }}</td>\n                    </tr>\n                </table>\n            </div>\n            <hr/>\n        </div>\n        <div class=\"mt40\">\n\n\n        <button pibButton type=\"button\" (click)=\"next()\" label=\"{{'hsbc-main.suivant' | translate}}\" class=\"btn--primary f-right\">\n                    </button>\n\n        <a (click)=\"goBack()\" class=\"btn--back\">{{'hsbc-main.retour'|translate}}</a>\n\n        <hr class=\"bottom-hr\" />\n\n        <div class=\"f-right bottom-help\">\n            <i class=\"icon icon-circle-help\"></i> {{'hsbc-main.help' | translate}}\n        </div>\n        </div>\n    </div>\n\n    \n</div>"
    ...
    UsefulDataService.prototype.getPatrimonyAmounts = function (lang) {
        if (lang == 'fr') {
            return [
                { label: 'Veuillez selectionner une valeur', value: null },
                { label: '0 €', value: '0' },
                { label: 'moins de 10 000 €', value: '0-10' },
                { label: 'de 10 000 € à 50 000 €', value: '10-50' },
                { label: 'de 50 000 € à 100 000 €', value: '50-100' },
                { label: 'de 100 000 € à 200 000 €', value: '100-200' },
                { label: 'plus de 200 000 €', value: '200' },
            ];
        }
        else {
            return [
